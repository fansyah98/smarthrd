...
/*jshint ignore:start*/
(function() {
    function oa(h, n) { h.prototype = cb(n.prototype);
        h.prototype.constructor = h;
        h.base = n.prototype }

    function cb(h) {
        function n() {}
        n.prototype = h; return new n }
    ...
    function Y(h, n) { var v = !1;
        0 > h && (v = !0, h *= -1);
        h = "" + h; for (n = n ? n : 1; h.length < n;) h = "0" + h; return v ? "-" + h : h }

    function Ea(h) { if (!h) return h;
        h = h.replace(/^\s\s*/, ""); for (var n = /\s/, v = h.length; n.test(h.charAt(--v));); return h.slice(0, v + 1) }

    function Aa(h) {
        h.roundRect = function(h, v, s, w, qa, E, x, F) {
            x && (this.fillStyle = x);
            ...
            this.beginPath();
            this.moveTo(h + qa, v);
            this.lineTo(h + s - qa, v);
            this.quadraticCurveTo(h + s, v, h + s, v + qa);
            this.lineTo(h + s,
                v + w - qa);
            this.quadraticCurveTo(h + s, v + w, h + s - qa, v + w);
    ...
    function Pa(h, n) { return h - n }

    function Q(h) { var n = ((h & 16711680) >> 16).toString(16),
            v = ((h & 65280) >> 8).toString(16);
        h = ((h & 255) >> 0).toString(16);
        n = 2 > n.length ? "0" + n : n;
        v = 2 > v.length ? "0" + v : v;
        h = 2 > h.length ? "0" + h : h; return "#" + n + v + h }
    ...
    function eb(h) { if (T.fSDec) h[X("`eeDwdouMhrudods")](X("e`u`@ohl`uhnoHuds`uhnoDoe"), function() { T._fTWm && T._fTWm(h) }) }
        ...
        if (isNaN(w)) {
            try {
                h = "position:absolute; left:0px; top:-20000px; padding:0px;margin:0px;border:none;white-space:pre;line-height:normal;font-family:" +
                    h + "; font-size:" + n + "px; font-weight:" + v + ";";
                if (!va) { var qa = document.body;
                    va = document.createElement("span");
                    va.innerHTML = ""; var E = document.createTextNode("Mpgyi");
                    va.appendChild(E);
                    qa.appendChild(va) }
                va.style.display = "";
    ...
    function J(h, n, v, w, Fa) {
        w = w || [];
        Fa = s(Fa) ? fb ? { passive: !1, capture: !1 } : !1 : Fa;
        w.push([h, n, v, Fa]);
        return h.addEventListener ? (h.addEventListener(n, v, Fa), v) : h.attachEvent ? (w = function(n) { n = n || window.event;
            n.preventDefault = n.preventDefault || function() { n.returnValue = !1 };
            n.stopPropagation = n.stopPropagation || function() { n.cancelBubble = !0 };
            v.call(h, n) }, h.attachEvent("on" +
            n, w), w) : !1
    }

    function gb(h) {
        if (h._menuButton) h.exportEnabled ? (ga(h._menuButton, { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }), Ka(h._menuButton)) : ta(h._menuButton);
            ...
            J(h._menuButton, "click", function() {
                "none" !== h._dropdownMenu.style.display || h._dropDownCloseTime &&
                    500 >= (new Date).getTime() - h._dropDownCloseTime.getTime() || (h._dropdownMenu.style.display = "block", h._menuButton.blur(), h._dropdownMenu.focus())
            }, h.allDOMEventHandlers, !0);
            J(h._menuButton, "mouseover", function() { n || (ga(h._menuButton, { backgroundColor: h.toolbar.itemBackgroundColorOnHover, color: h.toolbar.fontColorOnHover }), 0 >= navigator.userAgent.search("MSIE") && ga(h._menuButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" })) }, h.allDOMEventHandlers, !0);
            J(h._menuButton, "mouseout", function() {
                n ||
                    (ga(h._menuButton, { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }), 0 >= navigator.userAgent.search("MSIE") && ga(h._menuButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" }))
            }, h.allDOMEventHandlers, !0)
        }
        if (h.exportEnabled && h._dropdownMenu) { ga(h._dropdownMenu, { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }); for (var v = h._dropdownMenu.childNodes, s = 0; s < v.length; s++) ga(v[s], { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }) } else !h._dropdownMenu &&
            (h.exportEnabled && w) && (n = !1, h._dropdownMenu = document.createElement("div"), h._dropdownMenu.setAttribute("tabindex", -1), v = -1 !== h.theme.indexOf("dark") ? "black" : "#888888", h._dropdownMenu.style.cssText = "position: absolute; z-index: 1; -webkit-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none; cursor: pointer;right: 0px;top: 25px;min-width: 120px;outline: 0;font-size: 14px; font-family: Arial, Helvetica, sans-serif;padding: 5px 0px 5px 0px;text-align: left;line-height: 10px;background-color:" +
                h.toolbar.itemBackgroundColor + ";box-shadow: 2px 2px 10px " + v, h._dropdownMenu.style.display = "none", h._toolBar.appendChild(h._dropdownMenu), J(h._dropdownMenu, "blur", function() { ta(h._dropdownMenu);
                    h._dropDownCloseTime = new Date }, h.allDOMEventHandlers, !0), v = document.createElement("div"), v.style.cssText = "padding: 12px 8px 12px 8px", v.innerHTML = h._cultureInfo.printText, v.style.backgroundColor = h.toolbar.itemBackgroundColor, v.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(v), J(v, "touchstart",
                    ...
                    ta(h._dropdownMenu) }, h.allDOMEventHandlers, !0), v = document.createElement("div"), v.style.cssText = "padding: 12px 8px 12px 8px",
                v.innerHTML = h._cultureInfo.saveJPGText, v.style.backgroundColor = h.toolbar.itemBackgroundColor, v.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(v), J(v, "touchstart", function(h) { n = !0 }, h.allDOMEventHandlers), J(v, "mouseover", function() { n || (this.style.backgroundColor = h.toolbar.itemBackgroundColorOnHover, this.style.color = h.toolbar.fontColorOnHover) }, h.allDOMEventHandlers, !0), J(v, "mouseout", function() { n || (this.style.backgroundColor = h.toolbar.itemBackgroundColor, this.style.color = h.toolbar.fontColor) },
                    ...
                    ta(h._dropdownMenu) }, h.allDOMEventHandlers, !0), v = document.createElement("div"), v.style.cssText = "padding: 12px 8px 12px 8px", v.innerHTML = h._cultureInfo.savePNGText, v.style.backgroundColor = h.toolbar.itemBackgroundColor, v.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(v), J(v, "touchstart", function(h) { n = !0 }, h.allDOMEventHandlers), J(v, "mouseover", function() {
                    n || (this.style.backgroundColor =
                        h.toolbar.itemBackgroundColorOnHover, this.style.color = h.toolbar.fontColorOnHover)
                }, h.allDOMEventHandlers, !0), J(v, "mouseout", function() { n || (this.style.backgroundColor = h.toolbar.itemBackgroundColor, this.style.color = h.toolbar.fontColor) }, h.allDOMEventHandlers, !0), J(v, "click", function() { h.exportChart({ format: "png", fileName: h.exportFileName });
    ...
    function Ya(h, n, v) {
        ...
        n = !0;
        for (v = 0; 4 > v; v++)
            if (h[v] !== h[v + 4] | h[v] !== h[v + 8] |
                h[v] !== h[v + 12]) { n = !1; break }
        return n ? h[0] << 16 | h[1] << 8 | h[2] : 0
    }

    function la(h, n, v) { return h in n ? n[h] : v[h] }

    function La(h, n, v) { if (w && Za) { var s = h.getContext("2d");
            ...
            h.width = n * ka;
            h.height = v * ka;
            Qa !== Ma && (h.style.width = n + "px", h.style.height = v + "px", s.scale(ka, ka)) } else h.width = n, h.height = v }
    ...
    function hb(h) {
        if (!ib) {
            ...
            "undefined" === typeof pa.Chart.creditHref ?
                (h.creditHref = X("iuuqr;..b`ow`rkr/bnl."), h.creditText = X("B`ow`rKR/bnl")) : (n = h.updateOption("creditText"), v = h.updateOption("creditHref"));
    ...
    function ga(h, n) { for (var v in n) h.style[v] = n[v] }

    function ua(h, n, v) {
        n.getAttribute("state") || (n.style.backgroundColor = h.toolbar.itemBackgroundColor, n.style.color = h.toolbar.fontColor, n.style.border = "none", ga(n, { WebkitUserSelect: "none", MozUserSelect: "none", msUserSelect: "none", userSelect: "none" }));
        n.getAttribute("state") !==
            v && (n.setAttribute("state", v), n.setAttribute("type", "button"), ga(n, { padding: "5px 12px", cursor: "pointer", "float": "left", width: "40px", height: "25px", outline: "0px", verticalAlign: "baseline", lineHeight: "0" }), n.setAttribute("title", h._cultureInfo[v + "Text"]), n.innerHTML = "<img style='height:95%; pointer-events: none;' src='" + jb[v].image + "' alt='" + h._cultureInfo[v + "Text"] + "' />")
    }

    function Ka() { for (var h = null, n = 0; n < arguments.length; n++) h = arguments[n], h.style && (h.style.display = "inline") }
    ...
    function Ra(h, n, v, s, w) { if (null === h || "undefined" === typeof h) return "undefined" === typeof v ? n : v;
        h = parseFloat(h.toString()) * (0 <= h.toString().indexOf("%") ? n / 100 : 1); "undefined" !== typeof s && (h = Math.min(s, h), "undefined" !== typeof w && (h = Math.max(w, h))); return !isNaN(h) && h <= n && 0 <= h ? h : "undefined" === typeof v ? n : v }

    function V(h, n, v, w, x) {
        this._defaultsKey = h;
    ...
    function ia(h, n) { ia.base.constructor.call(this, "TextBlock", null, n, null, null);
        this.ctx = h;
        this._isDirty = !0;
        this._wrappedText = null;
        this._initialize() }

    function Sa(h, n) { Sa.base.constructor.call(this, "Toolbar", "toolbar", n, null, h);
        this.chart = h;
    ...
    function Ha(h, n, v) { Ha.base.constructor.call(this, "Subtitle", "subtitles", n, v, h);
        this.chart = h;
        this.canvas = h.canvas;
        this.ctx = this.chart.ctx;
    ...
    var U = 20,
        ...
        Ua = {
            ...
            title: { fontFamily: Da, fontSize: 32, fontColor: $, fontWeight: "normal", verticalAlign: "top", margin: 5 },
            subtitles: [{ fontFamily: Da, fontSize: F, fontColor: $, fontWeight: "normal", verticalAlign: "top", margin: 5 }],
            data: [{ indexLabelFontFamily: x, indexLabelFontSize: F, indexLabelFontColor: $, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }],
            axisX: [{
                titleFontFamily: x,
                titleFontSize: U,
                titleFontColor: $,
                ...
                crosshair: { labelFontFamily: x, labelFontSize: F, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: ha, color: da, thickness: 1, lineDashType: "dash" },
                scaleBreaks: {
                    type: "zigzag",
                    spacing: "2%",
                    lineColor: "#BBBBBB",
            ...
            legend: { fontFamily: x, fontSize: 14, fontColor: $, fontWeight: "bold", verticalAlign: "bottom", horizontalAlign: "center" },
    ...
    Da = {
        ...
        axisX2: [{
            ...
            crosshair: { labelFontFamily: x, labelFontSize: F, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: ha, color: da, thickness: 1, lineDashType: "dash" },
            scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#777777", lineThickness: 1, lineDashType: "solid", color: "#111111" }
        }],
        axisY: [{
            titleFontFamily: x,
        ...
        legend: { fontFamily: x, fontSize: 14, fontColor: $, fontWeight: "bold", verticalAlign: "bottom", horizontalAlign: "center" },
        toolTip: { fontFamily: x, fontSize: 14, fontStyle: "normal", cornerRadius: 0, borderThickness: 1, fontColor: Z, backgroundColor: "rgba(0, 0, 0, .7)" }
    };
    H = "#FFFFFF";
    Z = $ = "#FAFAFA";
    da = "#40BAF1";
    ...
    var U = 20,
        ...
        ab = {
            ...
            dark2: {
                ...
                title: { fontFamily: x, fontSize: 32, fontColor: $, fontWeight: "normal", verticalAlign: "top", margin: 5 },
                subtitles: [{ fontFamily: x, fontSize: F, fontColor: $, fontWeight: "normal", verticalAlign: "top", margin: 5 }],
                toolbar: { itemBackgroundColor: "#666666", itemBackgroundColorOnHover: "#FF7372", buttonBorderColor: "#FF7372", buttonBorderThickness: 1, fontColor: "#F5F5F5", fontColorOnHover: "#F5F5F5" },
                data: [{
                    indexLabelFontFamily: x,
                    indexLabelFontSize: F,
    ...
    (function() {
        T.fSDec = function(h) { for (var n = "", v = 0; v < h.length; v++) n += String.fromCharCode(Math.ceil(h.length / 57 / 5) ^ h.charCodeAt(v)); return n };
        T.obj = {
            wm: "B`ow`rKR!Ush`m",
        ...
        T._fTWm = function(h) {
            if ("undefined" === typeof T.pro.sCH && !bb) try {
                var n = (new Date).getMonth() % 3,
                    v, s, w = h[T.fSDec(T.obj.wmCtx)];
                w[T.fSDec(T.obj.wmTB)] = T.fSDec(T.obj.wmTop);
                w[T.fSDec(T.obj.wmFn)] = 11 + T.fSDec(T.obj.wmFnSt);
                w[T.fSDec(T.obj.wmFnS)] = T.fSDec(T.obj.wmFnClr);
                v = "cm" === T.pos[n] || "um" === T.pos[n] ? 0 : h.width - w[T.fSDec(T.obj.msrTxt)](T.fSDec(T.obj.wm)).width;
                s = "um" === T.pos[n] ? 0 : h.height - 11;
                w[T.fSDec(T.obj.wmFnT)](T.fSDec(T.obj.wm), v, s);
                "cs" === T.pos[n] && (h[T.fSDec("^bsdehuMhoj")].style.right = T.fSDec("`tun"))
            } catch (x) {}
        }
    })();
    var fb = function() { var h = !1; try { var n = Object.defineProperty && Object.defineProperty({}, "passive", { get: function() { h = !0; return !1 } });
                window.addEventListener && (window.addEventListener("test", null, n), window.removeEventListener("test", null, n)) } catch (v) { h = !1 } return h }(),
        Xa = {},
        va = null,
        kb = function() {
        ...
        lb = function(h, n, v) { n = Math.min(this.width, this.height); return Math.max("theme4" === this.theme ? 0 : 300 <= n ? 12 : 11, Math.round(n * (h / 400))) },
        za = function() {
                ...
                return M = N.replace(h, function(l) {
                    switch (l) {
                        ...
                        case "TT":
                            return 12 > d ? "AM" : "PM";
                        case "K":
                            return R ? "UTC" : (String(F).match(x) || [""]).pop().replace(E,
                                "");
                        case "z":
        ...
        ea = function(h, n, v) {
            ...
            for (var L = 0; F && L < F.length; L++)
                if (n = F[L], "." === n && 0 > N) N = L;
                    ...
                    else if ("\u2030" === n) { E *= 1E3; continue } else if ("," === n[0] && "." === n[n.length - 1]) { E /= Math.pow(1E3, n.length - 1);
                        N = L + n.length - 1; continue } else "E" !== n[0] && "e" !== n[0] || "0" !== n[n.length - 1] || (J = !0);
                    0 > N ? (M.push(n), "#" === n || "0" === n ? H++ : "," === n && R++) : (T.push(n), "#" !== n && "0" !== n || Q++) }
            J && (n = Math.floor(h), F = -Math.floor(Math.log(h) / Math.LN10 + 1), V = 0 === h ? 0 : 0 === n ? -(H + F) : String(n).length - H, E /= Math.pow(10, V));
            0 > N && (N = L);
            E = (h * E).toFixed(Q);
            n = E.split(".");
            E = (n[0] + "").split("");
            ...
            for (J = F = L = Q = N = 0; 0 < M.length;)
                if (n = M.pop(), "#" === n || "0" === n)
                    if (N++, N === H) { var W = E,
                            E = []; if ("0" === n)
                            for (n = H - Q - (W ? W.length : 0); 0 < n;) W.unshift("0"), n--; for (; 0 < W.length;) v = W.pop() + v, J++, 0 === J % F && (L === R && 0 < W.length) && (v = x + v) } else 0 < E.length ? (v = E.pop() + v, Q++, J++) : "0" === n && (v = "0" + v, Q++, J++), 0 === J % F && (L === R && 0 < E.length) && (v = x + v);
            else "E" !== n[0] && "e" !== n[0] || "0" !== n[n.length - 1] || !/[eE][+-]*[0]+/.test(n) ? "," === n ? (L++, F = J, J = 0, 0 < E.length &&
                (v = x + v)) : v = 1 < n.length && ('"' === n[0] && '"' === n[n.length - 1] || "'" === n[0] && "'" === n[n.length - 1]) ? n.slice(1, n.length - 1) + v : n + v : (n = 0 > V ? n.replace("+", "").replace("-", "") : n.replace("-", ""), v += n.replace(/[0]+/, function(a) { return Y(V, a.length) }));
            x = "";
            for (M = !1; 0 < T.length;) n = T.shift(), "#" === n || "0" === n ? 0 < h.length && 0 !== Number(h.join("")) ? (x += h.shift(), M = !0) : "0" === n && (x += "0", M = !0) : 1 < n.length && ('"' === n[0] && '"' === n[n.length - 1] || "'" === n[0] && "'" === n[n.length - 1]) ? x += n.slice(1, n.length - 1) : "E" !== n[0] && "e" !== n[0] || "0" !== n[n.length -
                1] || !/[eE][+-]*[0]+/.test(n) ? x += n : (n = 0 > V ? n.replace("+", "").replace("-", "") : n.replace("-", ""), x += n.replace(/[0]+/, function(a) { return Y(V, a.length) }));
            v += (M ? w : "") + x;
            return s ? "-" + v : v
        },
        Na = function(h) { var n = 0,
                v = 0;
            h = h || window.event;
            h.offsetX || 0 === h.offsetX ? (n = h.offsetX, v = h.offsetY) : h.layerX || 0 == h.layerX ? (n = h.layerX, v = h.layerY) : (n = h.pageX - h.target.offsetLeft, v = h.pageY - h.target.offsetTop); return { x: n, y: v } },
        Za = !0,
        Qa = window.devicePixelRatio || 1,
        Ma = 1,
        ka = Za ? Qa / Ma : 1,
        ca = function(h, n, v, s, w, x, E, F, N, M, T, Q, J) {
            "undefined" ===
            typeof J && (J = 1);
            E = E || 0;
            F = F || "black";
            var H = 15 < s - n && 15 < w - v ? 8 : 0.35 * Math.min(s - n, w - v);
            h.beginPath();
            h.moveTo(n, v);
            h.save();
            h.fillStyle = x;
            ...
            h.globalAlpha = 1;
            0 < E && (J = 0 === E % 2 ? 0 : 0.5, h.beginPath(), h.lineWidth = E, h.strokeStyle = F, h.moveTo(n, v), h.rect(n - J, v - J, s - n + 2 * J, w - v + 2 * J), h.stroke());
            h.restore();
            !0 === N && (h.save(), h.beginPath(), h.moveTo(n, v), h.lineTo(n + H, v + H), h.lineTo(s - H, v + H), h.lineTo(s, v), h.closePath(), E = h.createLinearGradient((s + n) / 2, v + H, (s + n) / 2, v), E.addColorStop(0, x),
                E.addColorStop(1, "rgba(255, 255, 255, .4)"), h.fillStyle = E, h.fill(), h.restore());
            !0 === M && (h.save(), h.beginPath(), h.moveTo(n, w), h.lineTo(n + H, w - H), h.lineTo(s - H, w - H), h.lineTo(s, w), h.closePath(), E = h.createLinearGradient((s + n) / 2, w - H, (s + n) / 2, w), E.addColorStop(0, x), E.addColorStop(1, "rgba(255, 255, 255, .4)"), h.fillStyle = E, h.fill(), h.restore());
            !0 === T && (h.save(), h.beginPath(), h.moveTo(n, v), h.lineTo(n + H, v + H), h.lineTo(n + H, w - H), h.lineTo(n, w), h.closePath(), E = h.createLinearGradient(n + H, (w + v) / 2, n, (w + v) / 2), E.addColorStop(0,
                x), E.addColorStop(1, "rgba(255, 255, 255, 0.1)"), h.fillStyle = E, h.fill(), h.restore());
            !0 === Q && (h.save(), h.beginPath(), h.moveTo(s, v), h.lineTo(s - H, v + H), h.lineTo(s - H, w - H), h.lineTo(s, w), E = h.createLinearGradient(s - H, (w + v) / 2, s, (w + v) / 2), E.addColorStop(0, x), E.addColorStop(1, "rgba(255, 255, 255, 0.1)"), h.fillStyle = E, E.addColorStop(0, x), E.addColorStop(1, "rgba(255, 255, 255, 0.1)"), h.fillStyle = E, h.fill(), h.closePath(), h.restore())
        },
        X = function(h) {
    ...
    V.prototype.setOptions = function(h, n) { if (pa[this._defaultsKey]) { var s = pa[this._defaultsKey],
                w; for (w in s) "publicProperties" !== w && s.hasOwnProperty(w) && (this[w] = h && w in h ? h[w] : n && w in n ? n[w] : s[w]) } else Ga && window.console && console.log("defaults not set") };
    ...
    V.prototype.set = function(h, n, s) {
    ...
    V.prototype.addTo = function(h, n, s, w) {
    ...
    V.prototype.createUserOptions = function(h) {
        if ("undefined" !== typeof h || this.options._isPlaceholder)
            if (this.parent.options._isPlaceholder &&
                this.parent.createUserOptions(), this.isOptionsInArray) { this.parent.options[this.optionsName] || (this.parent.options[this.optionsName] = []); var n = this.parent.options[this.optionsName],
                    s = n.length;
                this.options._isPlaceholder || (Ba(n), s = n.indexOf(this.options));
                this.options = "undefined" === typeof h ? {} : h;
                n[s] = this.options } else this.options = "undefined" === typeof h ? {} : h, h = this.parent.options, this.optionsName ? n = this.optionsName : (n = this._defaultsKey) && 0 !== n.length ? (s = n.charAt(0).toLowerCase(), 1 < n.length && (s = s.concat(n.slice(1))),
                n = s) : n = void 0, h[n] = this.options
    };
    V.prototype.remove = function(h) { h = "undefined" === typeof h ? !0 : h; if (this.isOptionsInArray) { var n = this.parent.options[this.optionsName];
            Ba(n); var s = n.indexOf(this.options);
            0 <= s && n.splice(s, 1) } else delete this.parent.options[this.optionsName];
    ...
    V.prototype.updateOption = function(h) {
        ...
        var n = pa[this._defaultsKey],
            ...
            H = this._index;
        this.theme && s(this.parent) && s(F) && s(H) ? w = s(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[F]) && (null === H ? w = this.parent.themeOptions[F] : 0 < this.parent.themeOptions[F].length && (w = Math.min(this.parent.themeOptions[F].length - 1, H), w = this.parent.themeOptions[F][w]));
        this.themeOptions = w;
    ...
    V.prototype.trackChanges = function(h) { if (!this.sessionVariables) throw "Session Variable Store not set";
        this.sessionVariables[h] = this.options[h] };
    V.prototype.isBeingTracked = function(h) { this.options._oldOptions || (this.options._oldOptions = {}); return this.options._oldOptions[h] ? !0 : !1 };
    ...
    V.prototype.addEventListener = function(h, n, s) {
        h && n && (this._eventListeners[h] =
            this._eventListeners[h] || [], this._eventListeners[h].push({ context: s || this, eventHandler: n }))
    };
    V.prototype.removeEventListener = function(h, n) { if (h && n && this._eventListeners[h])
    ...
    V.prototype.dispatchEvent = function(h, n, s) {
    ...
    Ca.prototype.registerSpace = function(h, n) { "top" === h ? this._topOccupied += n.height : "bottom" === h ? this._bottomOccupied += n.height : "left" === h ? this._leftOccupied += n.width : "right" === h && (this._rightOccupied += n.width) };
    Ca.prototype.unRegisterSpace = function(h, n) { "top" === h ? this._topOccupied -= n.height : "bottom" === h ? this._bottomOccupied -= n.height : "left" === h ? this._leftOccupied -= n.width : "right" === h && (this._rightOccupied -= n.width) };
        ...
        if (0 === this.frontSize) x = w = 0;
            ...
            for (; 0 < h.length;) {
                ...
                var H = x,
                    ...
                    w = w + E.height,
                    h = Ea(h.slice(E.text.length, h.length));
                F && w > F && (E = n.pop(), w -= E.height, x = H)
            }
    ...
    xa.prototype.setLayout = function() {
        if (this.text) {
            ...
            M = H.measureText();
            "top" === this.verticalAlign || "bottom" === this.verticalAlign ? ("top" === this.verticalAlign ? (x = n.y1 + 2, J = "top") : "bottom" === this.verticalAlign && (x = n.y2 - 2 - M.height, J = "bottom"), "left" === this.horizontalAlign ? w = n.x1 + 2 : "center" === this.horizontalAlign ? w = n.x1 + n.width / 2 - M.width / 2 : "right" === this.horizontalAlign && (w = n.x2 - 2 - M.width - E), N = this.horizontalAlign,
    ...
    Ta.prototype.get = function(h, n) {
        var w =
            null;
        0 < this.pool.length ? (w = this.pool.pop(), La(w, h, n)) : w = sa(h, n);
        return w
    };
    Ta.prototype.release = function(h) { this.pool.push(h) };
    oa(Ia, V);
    var Oa = { addTheme: function(h, n) { ab[h] = n }, addColorSet: function(h, n) { ya[h] = n }, addCultureInfo: function(h, n) { Ja[h] = n }, formatNumber: function(h, n, w) { w = w || "en"; if (Ja[w]) return ea(h, n || "#,##0.##", new Ia(w)); throw "Unknown Culture Name"; }, formatDate: function(h, n, w) { w = w || "en"; if (Ja[w]) return za(h, n || "DD MMM YYYY", new Ia(w)); throw "Unknown Culture Name"; } };
    ...
    x = Oa.Chart = function() {
            ...
            (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) ? (this.container.innerHTML = "", d = a = 0, a = this.options.width ?
                ...
                (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Aa(this.ctx), this._preRenderCtx = this._preRenderCanvas.getContext("2d"), this._preRenderCtx.textBaseline = "top", Aa(this._preRenderCtx), w ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = sa(a, d), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas), this.plotArea.ctx = this.plotArea.canvas.getContext("2d")),
                    this.overlaidCanvas = sa(a, d), this.overlaidCanvas.style.position = "absolute", this.overlaidCanvas.style.webkitTapHighlightColor = "transparent", this.overlaidCanvas.style.WebkitUserSelect = "none", this.overlaidCanvas.style.MozUserSelect = "none", this.overlaidCanvas.style.msUserSelect = "none", this.overlaidCanvas.style.userSelect = "none", this.overlaidCanvas.getContext && (this._canvasJSContainer.appendChild(this.overlaidCanvas), this.overlaidCanvasCtx = this.overlaidCanvas.getContext("2d"), this.overlaidCanvasCtx.textBaseline =
                        ...
                        this.allDOMEventHandlers), J(this.overlaidCanvas, "mousemove", function(a) { b._mouseEventHandler(a) }, this.allDOMEventHandlers), J(this.overlaidCanvas, "mouseup", function(a) { b._mouseEventHandler(a) }, this.allDOMEventHandlers), J(this.overlaidCanvas, "mousedown", function(a) { b._mouseEventHandler(a);
                        ta(b._dropdownMenu) }, this.allDOMEventHandlers), J(this.overlaidCanvas, "mouseout", function(a) { b._mouseEventHandler(a) }, this.allDOMEventHandlers), J(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerDown" :
                        "touchstart",
        ...
        function v(a, d) {
            for (var c = [], b, e = 0; e < a.length; e++)
                if (0 == e) c.push(a[0]);
                    ...
                    var A = (a[l].x - a[f].x) / b;
                    b = (a[l].y - a[f].y) / b;
                    c[c.length] = a[u].x > a[f].x && 0 < A || a[u].x < a[f].x && 0 > A ? { x: a[u].x + A / 3, y: a[u].y + b / 3 } : { x: a[u].x, y: a[u].y + b / 9 };
                    u = e;
                    f = 0 === u ? 0 : u - 1;
                    l = u === a.length - 1 ? u : u + 1;
        ...
        function x(a, d, c, b, e, f, l, u, A, k) {
            ...
            a.beginPath();
            A && 0 < l.thickness ? (a.moveTo(b - m, c), a.lineTo(b - m, e), a.moveTo(d + m, c), a.lineTo(d + m, e)) : 0 < l.thickness && (a.moveTo(d, c + m), a.lineTo(b, c + m), a.moveTo(d, e - m), a.lineTo(b, e - m));
            a.stroke();
            a.restore()
        }
        ...
        function $(a, d, c) { $.base.constructor.call(this, "Crosshair", "crosshair", d, null, c);
            this.chart = a;
            this.ctx = this.chart.ctx;
            this.axis = c;
            ...
            if (this.options.zoomEnabled || this.panEnabled) {
                if (this._zoomButton) ga(this._zoomButton, {
                    ...
                    J(this._zoomButton, "click", function() {
                        a.zoomEnabled ?
                            (a.zoomEnabled = !1, a.panEnabled = !0, ua(a, a._zoomButton, "zoom")) : (a.zoomEnabled = !0, a.panEnabled = !1, ua(a, a._zoomButton, "pan"));
                        a.render()
                    }, this.allDOMEventHandlers);
                    J(this._zoomButton, "mouseover", function() { d ? d = !1 : (ga(a._zoomButton, { backgroundColor: a.toolbar.itemBackgroundColorOnHover, color: a.toolbar.fontColorOnHover, transition: "0.4s", WebkitTransition: "0.4s" }), 0 >= navigator.userAgent.search("MSIE") && ga(a._zoomButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" })) }, this.allDOMEventHandlers);
            ...
            if (this.options.data) {
                for (var c = 0; c < this.options.data.length; c++)
                    if (a++, !this.options.data[c].type || 0 <= n._supportedChartTypes.indexOf(this.options.data[c].type)) {
                        ...
                        "error" === b.type && (b.linkedDataSeriesIndex = s(this.options.data[c].linkedDataSeriesIndex) ? c - 1 : this.options.data[c].linkedDataSeriesIndex, 0 > b.linkedDataSeriesIndex || b.linkedDataSeriesIndex >= this.options.data.length || "number" !== typeof b.linkedDataSeriesIndex || "error" === this.options.data[b.linkedDataSeriesIndex].type) && (b.linkedDataSeriesIndex =
                            null);
                        ...
                        null === b.color ? 1 < this.options.data.length ? (b._colorSet = [this.selectedColorSet[b.index % this.selectedColorSet.length]], b.color = this.selectedColorSet[b.index % this.selectedColorSet.length]) : b._colorSet = "line" === b.type || "stepLine" === b.type || "spline" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "stackedArea" === b.type || "stackedArea100" === b.type || "rangeArea" === b.type || "rangeSplineArea" === b.type || "candlestick" === b.type || "ohlc" === b.type ||
                            "waterfall" === b.type || "boxAndWhisker" === b.type ? [this.selectedColorSet[0]] : this.selectedColorSet : b._colorSet = [b.color];
        ...
        n._supportedChartTypes = Ba("line stepLine spline column area stepArea splineArea bar bubble scatter stackedColumn stackedColumn100 stackedBar stackedBar100 stackedArea stackedArea100 candlestick ohlc boxAndWhisker rangeColumn error rangeBar rangeArea rangeSplineArea pie doughnut funnel pyramid waterfall".split(" "));
        n.prototype.setLayout = function() {
            ...
            c ? (Ka(this._zoomButton, this._resetButton), this._toolBar.style.border = this.toolbar.buttonBorderThickness +
        ...
        n.prototype.renderElements = function() {
            ...
            for (d = 0; d < this.plotInfo.plotTypes.length; d++)
                for (var f = this.plotInfo.plotTypes[d], l = 0; l < f.plotUnits.length; l++) {
                    ...
                    "line" === u.type ? A = this.renderLine(u) : "stepLine" === u.type ? A = this.renderStepLine(u) : "spline" === u.type ? A = this.renderSpline(u) : "column" === u.type ? A = this.renderColumn(u) : "bar" === u.type ? A = this.renderBar(u) : "area" === u.type ? A = this.renderArea(u) : "stepArea" === u.type ? A = this.renderStepArea(u) : "splineArea" === u.type ?
            ...
            }, function() { c = []; for (var a = 0; a < m.plotInfo.plotTypes.length; a++)
            ...
            this.renderCount++;
            Ga && (m = this, setTimeout(function() { var a = document.getElementById("ghostCanvasCopy");
                a && (La(a, m.width, m.height), a.getContext("2d").drawImage(m._eventManager.ghostCanvas, 0, 0)) }, 2E3));
        ...
        n.prototype.render = function(a) { a && (this.options = a);
            this._initialize();
            this.setLayout();
            this.renderElements();
        ...
        n.prototype.assignIdToDataPoints = function() { for (var a = 0; a < this.data.length; a++) { var d = this.data[a]; if (d.dataPoints)
        ...
        n.prototype._processStackedPlotUnit = function(a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = [], u = [], A = Infinity, k = -Infinity, m = 0; m < a.dataSeriesIndexes.length; m++) {
                    var p =
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = !1, u = !1, A = [], k = 0; k < a.dataSeriesIndexes.length; k++) {
                    var m = this.data[a.dataSeriesIndexes[k]],
                        ...
                        g = !1,
                        r;
                    if ("normal" === m.axisPlacement || "xySwapped" === m.axisPlacement) var h = a.axisX.sessionVariables.newViewportMinimum ?
                        ...
                        n = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity;
                    if (m.dataPoints[p].x &&
                        m.dataPoints[p].x.getTime || "dateTime" === m.xValueType) f = !0;
                    for (p = 0; p < m.dataPoints.length; p++) {
                        ...
                        b > c.max && (c.max = b);
                        if (0 < p) {
                            if (a.axisX.logarithmic) { var t = b / m.dataPoints[p - 1].x;
                                1 > t && (t = 1 / t);
                                c.minDiff > t && 1 !== t && (c.minDiff = t) } else t = b - m.dataPoints[p - 1].x, 0 > t && (t *= -1), c.minDiff >
                                t && 0 !== t && (c.minDiff = t);
                            s(e) || null === m.dataPoints[p - 1].y || (a.axisY.logarithmic ? 0 < e && (t = e / m.dataPoints[p - 1].y, 1 > t && (t = 1 / t), d.minDiff > t && 1 !== t && (d.minDiff = t)) : (t = e - m.dataPoints[p - 1].y, 0 > t && (t *= -1), d.minDiff > t && 0 !== t && (d.minDiff = t)))
                        }
                        if (b < h && !q) null !== e && (r = b);
                        else {
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e,
                    ...
                    for (m = 0; m < k.dataPoints.length; m++) {
                        ...
                        if ((e = k.dataPoints[m].y) && e.length) { f = Math.min.apply(null, e);
                            l = Math.max.apply(null, e);
                            r = !0; for (var y = 0; y < e.length; y++) null === e.k && (r = !1);
                            r && (p || (h = g), g = b) }
                        b < c.min && (c.min = b);
                        b > c.max && (c.max = b);
                        f < d.min && (d.min = f);
                        l > d.max && (d.max = l);
                        0 < m && (a.axisX.logarithmic ? (r = b / k.dataPoints[m - 1].x, 1 > r && (r = 1 / r), c.minDiff > r && 1 !== r && (c.minDiff = r)) : (r = b - k.dataPoints[m - 1].x, 0 > r && (r *= -1), c.minDiff > r && 0 !== r && (c.minDiff = r)), e && (null !== e[0] && k.dataPoints[m - 1].y && null !== k.dataPoints[m - 1].y[0]) && (a.axisY.logarithmic ? (r = e[0] /
                            k.dataPoints[m - 1].y[0], 1 > r && (r = 1 / r), d.minDiff > r && 1 !== r && (d.minDiff = r)) : (r = e[0] - k.dataPoints[m - 1].y[0], 0 > r && (r *= -1), d.minDiff > r && 0 !== r && (d.minDiff = r))));
                        if (!(b < n) || p) {
                            if (!p && (p = !0, 0 < m)) { m -= 2;
                                g = h; continue }
                            if (b > t && !q) q = !0;
                            ...
                            if (c.viewPortMin === b && e)
                                for (y = 0; y < e.length; y++)
                                    if (null === e[y] && g < b) { c.viewPortMin = g; break }
        ...
        n.prototype.calculateAutoBreaks = function() {
            function a(a, b, c, e) {
                if (e) return c =
                    Math.pow(Math.min(c * a / b, b / a), 0.2), 1 >= c && (c = Math.pow(1 > a ? 1 / a : Math.min(b / a, a), 0.25)), { startValue: a * c, endValue: b / c };
            ...
            function d(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                    ...
                    if (b ||
                        c)
                        for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, k = f.min, l = f.max, m = d.min, p = d.max, f = f._dataRanges, d = d._dataRanges, q, u = 0, A = 0; A < a.dataSeriesIndexes.length; A++) {
                            ...
                            if (!(4 > h.dataPoints.length))
                                for (u = 0; u < h.dataPoints.length; u++)
                                    if (b && (q = (l + 1 - k) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, g = h.dataPoints[u].x.getTime ? h.dataPoints[u].x.getTime() : h.dataPoints[u].x, q = Math.floor((g - k) / q), g < f[q].min && (f[q].min = g), g > f[q].max && (f[q].max = g)), c) {
                                        var n =
                                            (p + 1 - m) * Math.max(parseFloat(a.axisY.scaleBreaks.collapsibleThreshold) || 10, 10) / 100;
            ...
            function c(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length) && a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <=
                    ...
                    for (var b = a.axisX.dataInfo, c = b.min, d = b.max, f = b._dataRanges, g, k = 0, l = 0; l < a.dataSeriesIndexes.length; l++) { var m = e.data[a.dataSeriesIndexes[l]]; if (!(4 > m.dataPoints.length))
                            for (k = 0; k < m.dataPoints.length; k++) g = (d + 1 - c) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, b = m.dataPoints[k].x.getTime ? m.dataPoints[k].x.getTime() : m.dataPoints[k].x, g = Math.floor((b - c) / g), b < f[g].min && (f[g].min = b), b > f[g].max && (f[g].max = b) }
            }
            for (var b, e = this, f = !1, l = 0; l <
                ...
                if (this._axes[l].scaleBreaks && this._axes[l].scaleBreaks.autoCalculate && 1 <= this._axes[l].scaleBreaks.maxNumberOfAutoBreaks) { f = !0;
                    this._axes[l].dataInfo._dataRanges = []; for (var u = 0; u < 100 / Math.max(parseFloat(this._axes[l].scaleBreaks.collapsibleThreshold) || 10, 10); u++) this._axes[l].dataInfo._dataRanges.push({ min: Infinity, max: -Infinity }) }
            if (f) {
                ...
                for (l = 0; l < this._axes.length; l++)
                    if (this._axes[l].dataInfo._dataRanges) {
                        ...
                        if (this._axes[l].dataInfo.dataPointYPositiveSums) { var q = this._axes[l].dataInfo.dataPointYPositiveSums;
                            m = k; for (u in q)
                                if (q.hasOwnProperty(u) && !isNaN(u) && (p = q[u], !s(p))) { var g = Math.floor((p - A) / b);
                                    p < m[g].min && (m[g].min = p);
                                    p > m[g].max && (m[g].max = p) }
                        ...
                        if (this._axes[l].dataInfo.dataPointYNegativeSums) {
                            ...
                            m = k;
                            for (u in q) q.hasOwnProperty(u) && !isNaN(u) && (p = -1 * q[u], s(p) || (g = Math.floor((p - A) / b), p < m[g].min && (m[g].min = p), p > m[g].max && (m[g].max = p)));
                            delete this._axes[l].dataInfo.dataPointYNegativeSums
                        }
                        for (u = 0; u < k.length - 1; u++)
                            if (m = k[u].max, isFinite(m))
                                for (; u < k.length - 1;)
                                    if (A = k[u + 1].min, isFinite(A)) { p = A - m;
                                        p > b && f.push({ diff: p, start: m, end: A }); break } else u++;
        ...
        n.prototype.getObjectAtXY = function(a, d, c) { var b = null; if (c = this.getDataPointAtXY(a, d, c || !1)) b = c.dataSeries.dataPointIds[c.dataPointIndex];
            ...
            if (a.changedTouches && this.interactivityEnabled) {
                ...
                if (!(c && 1 < c.length)) {
                    ...
                    try { var l = e.y - this._lastTouchData.y,
                            f = e.time - this._lastTouchData.time; if (1 < Math.abs(l) && this._lastTouchData.scroll || 5 < Math.abs(l) && 250 > f) this._lastTouchData.scroll = !0 } catch (u) {}
                    this._lastTouchEventType =
                        a.type;
        ...
        n.prototype._plotAreaMouseDown = function(a, d) { this.isDrag = !0;
        ...
        n.prototype._plotAreaMouseUp = function(a, d) {
            if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
                ...
                if (this.panEnabled || this.zoomEnabled) {
                    ...
                    else if ((!e || 2 < Math.abs(b)) && (!f || 2 < Math.abs(c)) && this.zoomEnabled) { if (!this.dragStartPoint) return;
        ...
        n.prototype._zoomPanToSelectedRegion = function(a, d, c, b,
            e) { a = this.validateRegion(a, d, c, b, e);
            d = a.axesWithValidRange;
            c = a.axesRanges; if (a.isValid)
                for (b = 0; b < d.length; b++) e = c[b], d[b].setViewPortRange(e.val1, e.val2), this.syncCharts && "y" != this.zoomType && this.syncCharts(e.val1, e.val2), this.stockChart && (this.stockChart._rangeEventParameter = { stockChart: this.stockChart, source: "chart", index: this.stockChart.charts.indexOf(this), minimum: e.val1, maximum: e.val2 }); return a.isValid };
        n.prototype.validateRegion = function(a, d, c, b, e) {
            e = e || !1;
            for (var f = 0 <= this.zoomType.indexOf("x"),
                    l = 0 <= this.zoomType.indexOf("y"), u = !1, A = [], k = [], m = [], p = 0; p < this._axes.length; p++)("axisX" === this._axes[p].type && f || "axisY" === this._axes[p].type && l) && k.push(this._axes[p]);
            for (l = 0; l < k.length; l++) {
                ...
                if (isFinite(p.dataInfo.minDiff))
                    if (r =
                        p.getApparentDifference(q, g, null, !0), !(f || !(this.panEnabled && p.scaleBreaks && p.scaleBreaks._appliedBreaks.length) && (p.logarithmic && r < Math.pow(p.dataInfo.minDiff, 3) || !p.logarithmic && r < 3 * Math.abs(p.dataInfo.minDiff)) || q < p.minimum || g > p.maximum)) A.push(p), m.push({ val1: q, val2: g }), u = !0;
                    else if (!e) { u = !1; break }
            }
            return { isValid: u, axesWithValidRange: A, axesRanges: m }
        };
        ...
        n.prototype.renderIndexLabels = function(a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                var m = this._indexLabels[a],
                    ...
                    u = la("indexLabelFontFamily", m.dataPoint, m.dataSeries),
                    A = la("indexLabelFontStyle", m.dataPoint, m.dataSeries),
                    k = la("indexLabelFontWeight", m.dataPoint,
                        m.dataSeries),
                ...
                var n = la("indexLabelLineDashType", m.dataPoint, m.dataSeries),
                    t = la("indexLabelLineColor", m.dataPoint, m.dataSeries),
                    ...
                    b = 0 < y ? Math.min(10, ("normal" === this.plotInfo.axisPlacement ?
                        this.plotArea.height : this.plotArea.width) << 0) : 0,
                    C = { percent: null, total: null },
                    B = null;
                if (0 <= m.dataSeries.type.indexOf("stacked") || "pie" === m.dataSeries.type || "doughnut" === m.dataSeries.type) C = this.getPercentAndTotal(m.dataSeries, m.dataPoint);
                if (m.dataSeries.indexLabelFormatter || m.dataPoint.indexLabelFormatter) B = { chart: this, dataSeries: m.dataSeries, dataPoint: m.dataPoint, index: m.indexKeyword, total: C.total, percent: C.percent };
                var D = m.dataPoint.indexLabelFormatter ? m.dataPoint.indexLabelFormatter(B) : m.dataPoint.indexLabel ?
                    this.replaceKeywordsWithValue(m.dataPoint.indexLabel, m.dataPoint, m.dataSeries, null, m.indexKeyword) : m.dataSeries.indexLabelFormatter ? m.dataSeries.indexLabelFormatter(B) : m.dataSeries.indexLabel ? this.replaceKeywordsWithValue(m.dataSeries.indexLabel, m.dataPoint, m.dataSeries, null, m.indexKeyword) : null;
                if (null !== D && "" !== D) {
                    var C = la("indexLabelPlacement", m.dataPoint, m.dataSeries),
                        B = la("indexLabelOrientation", m.dataPoint, m.dataSeries),
                        z = la("indexLabelTextAlign", m.dataPoint, m.dataSeries),
                        v = m.direction,
                        e = m.dataSeries.axisX,
                        f = m.dataSeries.axisY,
                        x = !1,
                        h = new ia(d, { x: 0, y: 0, maxWidth: q ? q : 0.5 * this.width, maxHeight: g ? 5 * r : 1.5 * r, angle: "horizontal" === B ? 0 : -90, text: D, padding: 0, backgroundColor: h, textAlign: z, fontSize: r, fontFamily: u, fontWeight: k, fontColor: l, fontStyle: A, textBaseline: "middle" });
                    h.measureText();
                    ...
                    } else if (0 <= p.indexOf("line") || 0 <= p.indexOf("area") || 0 <= p.indexOf("bubble") || 0 <= p.indexOf("scatter")) { if (m.dataPoint.x < e.viewportMinimum || m.dataPoint.x > e.viewportMaximum || m.dataPoint.y < f.viewportMinimum || m.dataPoint.y > f.viewportMaximum) continue } else if (0 <= p.indexOf("column") || "waterfall" === p || "error" === p && !m.axisSwapped) {
                        if (m.dataPoint.x < e.viewportMinimum ||
                            m.dataPoint.x > e.viewportMaximum || m.bounds.y1 > c.y2 || m.bounds.y2 < c.y1) continue
                    } else if (0 <= p.indexOf("bar") || "error" === p) { if (m.dataPoint.x < e.viewportMinimum || m.dataPoint.x > e.viewportMaximum || m.bounds.x1 > c.x2 || m.bounds.x2 < c.x1) continue } else if ("candlestick" === p || "ohlc" === p) { if (m.dataPoint.x < e.viewportMinimum || m.dataPoint.x > e.viewportMaximum || Math.max.apply(null, m.dataPoint.y) < f.viewportMinimum || Math.min.apply(null, m.dataPoint.y) > f.viewportMaximum) continue } else if (m.dataPoint.x < e.viewportMinimum || m.dataPoint.x >
                        e.viewportMaximum) continue;
                    l = u = 2;
                    "horizontal" === B ? (A = h.width, k = h.height) : (k = h.width, A = h.height);
                    if ("normal" === this.plotInfo.axisPlacement) {
                        if (0 <= p.indexOf("line") || 0 <= p.indexOf("area")) C = "auto", u = 4;
                        else if (0 <= p.indexOf("stacked")) "auto" === C && (C = "inside");
                        else if ("bubble" === p || "scatter" === p) C = "inside";
                        q = m.point.x - ("horizontal" === B ? A / 2 : A / 2 - r / 2);
                        "inside" !== C ? (e = c.y1, f = c.y2, 0 < v ? (g = m.point.y + ("horizontal" === B ? r / 2 : 0) - k - u - b, g < e && (g = "auto" === C ? Math.max(m.point.y, e) + r / 2 + u : e + r / 2 + u, x = g + k > m.point.y)) : (g = m.point.y +
                            ...
                            p) && (g = Math.min(m.point.y + u, c.y2 - k - u))), g = Math.min(g, f))
                    } else 0 <= p.indexOf("line") || 0 <= p.indexOf("area") || 0 <= p.indexOf("scatter") ? (C = "auto", l = 4) : 0 <= p.indexOf("stacked") ? "auto" === C && (C = "inside") : "bubble" === p && (C = "inside"), g = m.point.y + r / 2 - k / 2 + u, "inside" !== C ? (e = c.x1, f = c.x2, 0 > v ? (q = m.point.x - ("horizontal" === B ? A : A - r / 2) - l - b, q < e && (q = "auto" === C ? Math.max(m.point.x, e) + l : e + l, x = q + A > m.point.x)) : (q = m.point.x + ("horizontal" === B ? 0 : r / 2) + l + b, q > f - A - l - b && (q = "auto" === C ? Math.min(m.point.x, f) - ("horizontal" === B ? A : A / 2) - l : f -
                    ...
                    h.y = g;
                    h.render(!0);
                    y && ("inside" !== C && (0 > p.indexOf("bar") && ("error" !== p || !m.axisSwapped) &&
                        ...
                        (g - k < m.point.y ? 0 : -k) + u : (g - r / 2 < m.point.y ? k : 0) - r / 2)) : d.lineTo(q + A / 2 - ("horizontal" === B ? 0 : r / 2), g + ("vertical" === B ? g - k < m.point.y ? 0 : -k : (g - r / 2 < m.point.y ? k : 0) - r / 2)), d.stroke())
                }
            }
        ...
        n.prototype.renderLine = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], l, u = 0; u < a.dataSeriesIndexes.length; u++) {
                    ...
                    c.beginPath();
                    if (0 < m.length) {
                        for (var B = !1, t = 0; t < m.length; t++)
                            if (y = m[t].x.getTime ? m[t].x.getTime() : m[t].x, !(y < a.axisX.dataInfo.viewPortMin || y > a.axisX.dataInfo.viewPortMax && (!k.connectNullData ||
                                    !B)))
                                if ("number" !== typeof m[t].y) 0 < t && !(k.connectNullData || B || n) && (c.stroke(), w && b.stroke()), B = !0;
                                else {
                                    y = a.axisX.convertValueToPixel(y);
                                    s = a.axisY.convertValueToPixel(m[t].y);
                                    var D = k.dataPointIds[t];
                                    this._eventManager.objectMap[D] = { id: D, objectType: "dataPoint", dataSeriesIndex: A, dataPointIndex: t, x1: y, y1: s };
                                    n || B ? (!n && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(l.x, l.y), p = k.nullDataLineDashType,
                                        c.setLineDash(q)), c.lineTo(y, s), w && b.lineTo(y, s)) : (c.beginPath(), c.moveTo(y, s), w && (b.beginPath(), b.moveTo(y, s))), B = n = !1) : (c.lineTo(y, s), w && b.lineTo(y, s), 0 == t % 500 && (c.stroke(), c.beginPath(), c.moveTo(y, s), w && (b.stroke(), b.beginPath(), b.moveTo(y, s))));
                                    l = { x: y, y: s };
                                    t < m.length - 1 && (h !== (m[t].lineColor || r) || p !== (m[t].lineDashType || k.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(y, s), h = m[t].lineColor || r, c.strokeStyle = h, c.setLineDash && (m[t].lineDashType ? (p = m[t].lineDashType, c.setLineDash(N(p, k.lineThickness))) :
                                        (p = k.lineDashType, c.setLineDash(g))));
                                    if (0 < m[t].markerSize || 0 < k.markerSize) { var z = k.getMarkerProperties(t, y, s, c);
                                        f.push(z);
                                        D = Q(D);
                                        w && f.push({ x: y, y: s, ctx: b, type: z.type, size: z.size, color: D, borderColor: D, borderThickness: z.borderThickness }) }(m[t].indexLabel || k.indexLabel || m[t].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({ chartType: "line", dataPoint: m[t], dataSeries: k, point: { x: y, y: s }, direction: 0 > m[t].y === a.axisY.reversed ? 1 : -1, color: r })
                                }
                        c.stroke();
                        w && b.stroke()
                    }
        ...
        n.prototype.renderStepLine = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], l, u = 0; u < a.dataSeriesIndexes.length; u++) {
                    ...
                    if (0 < m.length) {
                        for (var B = !1, t = 0; t < m.length; t++)
                            if (y = m[t].getTime ? m[t].x.getTime() : m[t].x, !(y < a.axisX.dataInfo.viewPortMin || y > a.axisX.dataInfo.viewPortMax &&
                                    (!k.connectNullData || !B)))
                                if ("number" !== typeof m[t].y) 0 < t && !(k.connectNullData || B || n) && (c.stroke(), w && b.stroke()), B = !0;
                                else {
                                    var D = s;
                                    ...
                                    this._eventManager.objectMap[z] = { id: z, objectType: "dataPoint", dataSeriesIndex: A, dataPointIndex: t, x1: y, y1: s };
                                    n || B ? (!n && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(l.x,
                                        l.y), p = k.nullDataLineDashType, c.setLineDash(q)), c.lineTo(y, D), c.lineTo(y, s), w && (b.lineTo(y, D), b.lineTo(y, s))) : (c.beginPath(), c.moveTo(y, s), w && (b.beginPath(), b.moveTo(y, s))), B = n = !1) : (c.lineTo(y, D), w && b.lineTo(y, D), c.lineTo(y, s), w && b.lineTo(y, s), 0 == t % 500 && (c.stroke(), c.beginPath(), c.moveTo(y, s), w && (b.stroke(), b.beginPath(), b.moveTo(y, s))));
                                    l = { x: y, y: s };
                                    t < m.length - 1 && (h !== (m[t].lineColor || r) || p !== (m[t].lineDashType || k.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(y, s), h = m[t].lineColor || r, c.strokeStyle =
                                        h, c.setLineDash && (m[t].lineDashType ? (p = m[t].lineDashType, c.setLineDash(N(p, k.lineThickness))) : (p = k.lineDashType, c.setLineDash(g))));
                                    if (0 < m[t].markerSize || 0 < k.markerSize) D = k.getMarkerProperties(t, y, s, c), f.push(D), z = Q(z), w && f.push({ x: y, y: s, ctx: b, type: D.type, size: D.size, color: z, borderColor: z, borderThickness: D.borderThickness });
                                    (m[t].indexLabel || k.indexLabel || m[t].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
                                        chartType: "stepLine",
                                        dataPoint: m[t],
                                        dataSeries: k,
                                        point: { x: y, y: s },
                                        direction: 0 >
                                            m[t].y === a.axisY.reversed ? 1 : -1,
                                        color: r
                                    })
                                }
                        c.stroke();
                ...
                for (var l = [], u = 0; u < a.dataSeriesIndexes.length; u++) {
                    ...
                    if (0 < m.length)
                        for (y = !1, n = 0; n < m.length; n++)
                            if (t = m[n].getTime ? m[n].x.getTime() : m[n].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !y)))
                                if ("number" !== typeof m[n].y) 0 < n && !y && (k.connectNullData ? b.setLineDash && (0 < s.length && (k.options.nullDataLineDashType || !m[n - 1].lineDashType)) && (s[s.length -
                                    1].newLineDashArray = q, p = k.nullDataLineDashType) : (d(s), s = [])), y = !0;
                                else {
                                    t = a.axisX.convertValueToPixel(t);
                                    y = a.axisY.convertValueToPixel(m[n].y);
                                    var B = k.dataPointIds[n];
                                    this._eventManager.objectMap[B] = { id: B, objectType: "dataPoint", dataSeriesIndex: A, dataPointIndex: n, x1: t, y1: y };
                                    s[s.length] = { x: t, y: y };
                                    n < m.length - 1 && (h !== (m[n].lineColor || r) || p !== (m[n].lineDashType || k.lineDashType)) && (h = m[n].lineColor || r, s[s.length - 1].newStrokeStyle = h, b.setLineDash && (m[n].lineDashType ? (p = m[n].lineDashType, s[s.length - 1].newLineDashArray =
                                        N(p, k.lineThickness)) : (p = k.lineDashType, s[s.length - 1].newLineDashArray = g)));
                                    if (0 < m[n].markerSize || 0 < k.markerSize) { var D = k.getMarkerProperties(n, t, y, b);
                                        l.push(D);
                                        B = Q(B);
                                        w && l.push({ x: t, y: y, ctx: e, type: D.type, size: D.size, color: B, borderColor: B, borderThickness: D.borderThickness }) }(m[n].indexLabel || k.indexLabel || m[n].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({ chartType: "spline", dataPoint: m[n], dataSeries: k, point: { x: t, y: y }, direction: 0 > m[n].y === a.axisY.reversed ? 1 : -1, color: r });
                                    y = !1
                                }
                    d(s)
                }
        ...
        n.prototype.renderColumn = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                !this.dataPointMaxWidth && (this.dataPointMinWidth &&
                    m < f) && (m = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, f));
                p < f && (p = f);
                p > m && (p = m);
                c.save();
                    ...
                    if (0 < r.length)
                        for (var h = 5 < p && g.bevelEnabled ? !0 : !1, f =
                            ...
                            if (r[f].getTime ? A = r[f].x.getTime() : A = r[f].x, !(A < a.axisX.dataInfo.viewPortMin || A > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[f].y) {
                                ...
                                ca(c, l, u, n, t, b, 0, null, h && 0 <= r[f].y, 0 > r[f].y && h, !1, !1, g.fillOpacity);
                                b = g.dataPointIds[f];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: l, y1: u, x2: n, y2: t };
                                b = Q(b);
                                w && ca(this._eventManager.ghostCtx, l, u, n, t, b, 0, null, !1, !1, !1, !1);
                                (r[f].indexLabel || g.indexLabel || r[f].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "column",
                                    dataPoint: r[f],
                                    dataSeries: g,
                                    point: { x: l + (n - l) / 2, y: 0 > r[f].y === a.axisY.reversed ? u : t },
                                    direction: 0 > r[f].y ===
                                        a.axisY.reversed ? 1 : -1,
                                    bounds: { x1: l, y1: Math.min(u, t), x2: n, y2: Math.max(u, t) },
                                    color: b
                                })
                            }
                }
                ...
                c.restore();
                return { source: d, dest: this.plotArea.ctx, animationCallback: L.yScaleAnimation, easingFunction: L.easing.easeOutQuart, animationBase: k < a.axisY.bounds.y1 ? a.axisY.bounds.y1 : k > a.axisY.bounds.y2 ? a.axisY.bounds.y2 : k }
            }
        };
        n.prototype.renderStackedColumn = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                this.dataPointMaxWidth &&
                    k > m && (k = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, m));
                        ...
                        for (k = 0; k < t.length; k++)
                            if (b = t[k].x.getTime ? t[k].x.getTime() : t[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[k].y) {
                                ...
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[k].y) u[b] = t[k].y + (u[b] ? u[b] :
                                    0), 0 < u[b] && (p = a.axisY.convertValueToPixel(u[b]), D = "undefined" !== typeof f[b] ? f[b] : q, f[b] = p);
                                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[k].y) A[b] = t[k].y + (A[b] ? A[b] : 0), D = a.axisY.convertValueToPixel(A[b]), p = "undefined" !== typeof l[b] ? l[b] : q, l[b] = D;
                                else if (p = a.axisY.convertValueToPixel(t[k].y), 0 <= t[k].y) { var z = "undefined" !== typeof f[b] ? f[b] : 0;
                                    p -= z;
                                    D = q - z;
                                    f[b] = z + (D - p) } else z = l[b] ? l[b] : 0, D = p + z, p = q + z, l[b] = z + (D - p);
                                b = t[k].color ? t[k].color : n._colorSet[k % n._colorSet.length];
                                ca(c, s, p, B, D, b, 0, null, y && 0 <= t[k].y, 0 > t[k].y && y, !1, !1, n.fillOpacity);
                                b = n.dataPointIds[k];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: s, y1: p, x2: B, y2: D };
                                b = Q(b);
                                w && ca(this._eventManager.ghostCtx, s, p, B, D, b, 0, null, !1, !1, !1, !1);
                                (t[k].indexLabel || n.indexLabel || t[k].indexLabelFormatter || n.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "stackedColumn",
                                    dataPoint: t[k],
                                    dataSeries: n,
                                    point: { x: m, y: 0 <= t[k].y ? p : D },
                                    direction: 0 > t[k].y === a.axisY.reversed ?
                                        1 : -1,
                                    bounds: { x1: s, y1: Math.min(p, D), x2: B, y2: Math.max(p, D) },
                                    color: b
                                })
                            }
                    }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                    var h =
                        ...
                        t = n.dataPoints;
                    if (0 < t.length)
                        for (var y = 5 < g && n.bevelEnabled ? !0 : !1, k = 0; k < t.length; k++)
                            if (b = t[k].x.getTime ? t[k].x.getTime() : t[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[k].y) {
                                m = a.axisX.convertValueToPixel(b);
                                ...
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length &&
                                    0 < t[k].y) { u[b] = p + ("undefined" !== typeof u[b] ? u[b] : 0); if (0 >= u[b]) continue;
                                    p = a.axisY.convertValueToPixel(u[b]);
                                    D = f[b] ? f[b] : q;
                                    f[b] = p } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[k].y) A[b] = p + ("undefined" !== typeof A[b] ? A[b] : 0), D = a.axisY.convertValueToPixel(A[b]), p = l[b] ? l[b] : q, l[b] = D;
                                else if (p = a.axisY.convertValueToPixel(p), 0 <= t[k].y) { var z = "undefined" !== typeof f[b] ? f[b] : 0;
                                    p -= z;
                                    D = q - z;
                                    a.dataSeriesIndexes.length - 1 === r && 1 >= Math.abs(e.y1 - p) && (p = e.y1);
                                    f[b] = z + (D - p) } else z = "undefined" !==
                                    typeof l[b] ? l[b] : 0, D = p + z, p = q + z, a.dataSeriesIndexes.length - 1 === r && 1 >= Math.abs(e.y2 - D) && (D = e.y2), l[b] = z + (D - p);
                                b = t[k].color ? t[k].color : n._colorSet[k % n._colorSet.length];
                                ca(c, s, p, B, D, b, 0, null, y && 0 <= t[k].y, 0 > t[k].y && y, !1, !1, n.fillOpacity);
                                b = n.dataPointIds[k];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: s, y1: p, x2: B, y2: D };
                                b = Q(b);
                                w && ca(this._eventManager.ghostCtx, s, p, B, D, b, 0, null, !1, !1, !1, !1);
                                (t[k].indexLabel || n.indexLabel || t[k].indexLabelFormatter || n.indexLabelFormatter) &&
                                this._indexLabels.push({ chartType: "stackedColumn100", dataPoint: t[k], dataSeries: n, point: { x: m, y: 0 <= t[k].y ? p : D }, direction: 0 > t[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: s, y1: Math.min(p, D), x2: B, y2: Math.max(p, D) }, color: b })
                            }
                }
                    ...
                    if (0 < r.length) {
                        ...
                        for (f = 0; f < r.length; f++)
                            if (r[f].getTime ? A = r[f].x.getTime() : A = r[f].x, !(A < a.axisX.dataInfo.viewPortMin || A > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[f].y) {
                                ...
                                u = a.axisX.reversed ? u + a.plotType.totalDataSeries * p / 2 - (a.previousDataSeriesCount + m) * p << 0 : u - a.plotType.totalDataSeries * p / 2 + (a.previousDataSeriesCount + m) * p << 0;
                                var n = a.axisX.reversed ? u - p << 0 : u + p << 0,
                                    t;
                                0 <= r[f].y ? t = k : (t = l, l = k);
                                b = r[f].color ? r[f].color : g._colorSet[f % g._colorSet.length];
                                ca(c, t, u, l, n, b, 0, null, h, !1, !1, !1, g.fillOpacity);
                                b = g.dataPointIds[f];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: t, y1: u, x2: l, y2: n };
                                b =
                                    Q(b);
                                w && ca(this._eventManager.ghostCtx, t, u, l, n, b, 0, null, !1, !1, !1, !1);
                                (r[f].indexLabel || g.indexLabel || r[f].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({ chartType: "bar", dataPoint: r[f], dataSeries: g, point: { x: 0 <= r[f].y ? l : t, y: u + (n - u) / 2 }, direction: 0 > r[f].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(t, l), y1: u, x2: Math.max(t, l), y2: n }, color: b })
                            }
                    }
                }
                        ...
                        for (k = 0; k < t.length; k++)
                            if (b = t[k].x.getTime ? t[k].x.getTime() :
                                ...
                                var s = p - a.plotType.plotUnits.length * g / 2 + a.index * g << 0,
                                    B = s + g << 0,
                                    D;
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[k].y) u[b] = t[k].y + (u[b] ? u[b] : 0), 0 < u[b] && (D = f[b] ? f[b] : q, f[b] = m = a.axisY.convertValueToPixel(u[b]));
                                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[k].y) A[b] = t[k].y + (A[b] ? A[b] : 0), m = l[b] ?
                                    l[b] : q, l[b] = D = a.axisY.convertValueToPixel(A[b]);
                                else if (m = a.axisY.convertValueToPixel(t[k].y), 0 <= t[k].y) { var z = f[b] ? f[b] : 0;
                                    D = q + z;
                                    m += z;
                                    f[b] = z + (m - D) } else z = l[b] ? l[b] : 0, D = m - z, m = q - z, l[b] = z + (m - D);
                                b = t[k].color ? t[k].color : n._colorSet[k % n._colorSet.length];
                                ca(c, D, s, m, B, b, 0, null, y, !1, !1, !1, n.fillOpacity);
                                b = n.dataPointIds[k];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: D, y1: s, x2: m, y2: B };
                                b = Q(b);
                                w && ca(this._eventManager.ghostCtx, D, s, m, B, b, 0, null, !1, !1, !1, !1);
                                (t[k].indexLabel || n.indexLabel || t[k].indexLabelFormatter || n.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar", dataPoint: t[k], dataSeries: n, point: { x: 0 <= t[k].y ? m : D, y: p }, direction: 0 > t[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(D, m), y1: s, x2: Math.max(D, m), y2: B }, color: b })
                            }
                    }
                }
                    ...
                    if (0 < t.length) {
                        ...
                        for (k = 0; k < t.length; k++)
                            if (b = t[k].x.getTime ? t[k].x.getTime() : t[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) &&
                                ...
                                p = a.axisX.convertValueToPixel(b);
                                var C;
                                C = 0 !== a.dataPointYSums[b] ? 100 * (t[k].y / a.dataPointYSums[b]) : 0;
                                var B = p - a.plotType.plotUnits.length * g / 2 + a.index * g << 0,
                                    D = B + g << 0;
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[k].y) { u[b] = C + (u[b] ? u[b] : 0); if (0 >= u[b]) continue;
                                    C = f[b] ? f[b] : q;
                                    f[b] = m = a.axisY.convertValueToPixel(u[b]) } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[k].y) A[b] = C + (A[b] ? A[b] : 0), m = l[b] ? l[b] :
                                    q, l[b] = C = a.axisY.convertValueToPixel(A[b]);
                                else if (m = a.axisY.convertValueToPixel(C), 0 <= t[k].y) { var z = f[b] ? f[b] : 0;
                                    C = q + z;
                                    m += z;
                                    a.dataSeriesIndexes.length - 1 === r && 1 >= Math.abs(e.x2 - m) && (m = e.x2);
                                    f[b] = z + (m - C) } else z = l[b] ? l[b] : 0, C = m - z, m = q - z, a.dataSeriesIndexes.length - 1 === r && 1 >= Math.abs(e.x1 - C) && (C = e.x1), l[b] = z + (m - C);
                                b = t[k].color ? t[k].color : n._colorSet[k % n._colorSet.length];
                                ca(c, C, B, m, D, b, 0, null, s, !1, !1, !1, n.fillOpacity);
                                b = n.dataPointIds[k];
                                ...
                                b = Q(b);
                                w && ca(this._eventManager.ghostCtx, C, B, m, D, b, 0, null, !1, !1, !1, !1);
                                (t[k].indexLabel || n.indexLabel || t[k].indexLabelFormatter || n.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar100", dataPoint: t[k], dataSeries: n, point: { x: 0 <= t[k].y ? m : C, y: p }, direction: 0 > t[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(C, m), y1: B, x2: Math.max(C, m), y2: D }, color: b })
                            }
                    }
                }
        ...
        n.prototype.renderArea = function(a) {
            ...
            function b() { D && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? B = C : 0 > a.axisY.viewportMaximum ? B = u.y1 : 0 < a.axisY.viewportMinimum && (B = C), f.lineTo(n, B), f.lineTo(D.x, B), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha = 1, w && (l.lineTo(n, B), l.lineTo(D.x, B), l.closePath(), l.fill()), f.beginPath(), f.moveTo(n, t), l.beginPath(), l.moveTo(n, t), D = { x: n, y: t }) }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    d = !0;
                    var h = 0,
                        n, t, s, C = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                        B, D = null;
                    if (0 < r.length) {
                        ...
                        c = "solid";
                        if (f.setLineDash) { var S = N(g.nullDataLineDashType, g.lineThickness);
                            c = g.lineDashType; var P = N(c, g.lineThickness);
                            f.setLineDash(P) }
                        for (var ja = !0; h < r.length; h++)
                            if (s = r[h].x.getTime ? r[h].x.getTime() : r[h].x, !(s < a.axisX.dataInfo.viewPortMin ||
                                ...
                                if ("number" !== typeof r[h].y) g.connectNullData || (ja || d) || b(), ja = !0;
                                    ...
                                    d || ja ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || c === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = n, c = t, n = m.x, t = m.y, b(), f.moveTo(m.x, m.y), n = d, t = c, D = m, c = g.nullDataLineDashType, f.setLineDash(S)), f.lineTo(n, t), w && l.lineTo(n, t)) : (f.beginPath(), f.moveTo(n, t), w &&
                                        (l.beginPath(), l.moveTo(n, t)), D = { x: n, y: t }), ja = d = !1) : (f.lineTo(n, t), w && l.lineTo(n, t), 0 == h % 250 && b());
                                    m = { x: n, y: t };
                                    h < r.length - 1 && (x !== (r[h].lineColor || v) || c !== (r[h].lineDashType || g.lineDashType)) && (b(), x = r[h].lineColor || v, f.strokeStyle = x, f.setLineDash && (r[h].lineDashType ? (c = r[h].lineDashType, f.setLineDash(N(c, g.lineThickness))) : (c = g.lineDashType, f.setLineDash(P))));
                                    var aa = g.dataPointIds[h];
                                    this._eventManager.objectMap[aa] = { id: aa, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: h, x1: n, y1: t };
                                    0 !==
                                        r[h].markerSize && (0 < r[h].markerSize || 0 < g.markerSize) && (s = g.getMarkerProperties(h, n, t, f), A.push(s), aa = Q(aa), w && A.push({ x: n, y: t, ctx: l, type: s.type, size: s.size, color: aa, borderColor: aa, borderThickness: s.borderThickness }));
                                    (r[h].indexLabel || g.indexLabel || r[h].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({ chartType: "area", dataPoint: r[h], dataSeries: g, point: { x: n, y: t }, direction: 0 > r[h].y === a.axisY.reversed ? 1 : -1, color: z })
                                }
                        b();
                        W.drawMarkers(A)
                    }
                }
                w && (e.drawImage(this._preRenderCanvas, 0, 0,
        ...
        n.prototype.renderSplineArea = function(a) {
            function d() {
                ...
                if (0 < c.length) {
                    ...
                    b.fill();
                    b.globalAlpha = 1;
                    w && (e.lineTo(c[c.length - 1].x, n), e.lineTo(t.x, n), e.closePath(), e.fill())
                }
            }
            var c = a.targetCanvasCtx || this.plotArea.ctx,
                b = w ? this._preRenderCtx : c;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var A = 0; A < a.dataSeriesIndexes.length; A++) {
                    ...
                    var l = [],
                        ...
                        s = [];
                    if (0 < p.length) {
                        var C = m._colorSet[q % m._colorSet.length],
                            B = m.lineColor = m.options.lineColor ||
                            C,
                            D = B;
                        b.fillStyle = C;
                        b.strokeStyle = B;
                        ...
                        var z = "solid";
                        if (b.setLineDash) { var x = N(m.nullDataLineDashType, m.lineThickness),
                                z = m.lineDashType,
                        ...
                        for (r = !1; q < p.length; q++)
                            if (g = p[q].x.getTime ? p[q].x.getTime() : p[q].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !r)))
                                if ("number" !== typeof p[q].y) 0 < q && !r && (m.connectNullData ? b.setLineDash && (0 < s.length && (m.options.nullDataLineDashType || !p[q - 1].lineDashType)) &&
                                    (s[s.length - 1].newLineDashArray = x, z = m.nullDataLineDashType) : (d(), s = [])), r = !0;
                                else {
                                    g = a.axisX.convertValueToPixel(g);
                                    r = a.axisY.convertValueToPixel(p[q].y);
                                    var S = m.dataPointIds[q];
                                    this._eventManager.objectMap[S] = { id: S, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: q, x1: g, y1: r };
                                    s[s.length] = { x: g, y: r };
                                    q < p.length - 1 && (D !== (p[q].lineColor || B) || z !== (p[q].lineDashType || m.lineDashType)) && (D = p[q].lineColor || B, s[s.length - 1].newStrokeStyle = D, b.setLineDash && (p[q].lineDashType ? (z = p[q].lineDashType, s[s.length -
                                        1].newLineDashArray = N(z, m.lineThickness)) : (z = m.lineDashType, s[s.length - 1].newLineDashArray = E)));
                                    if (0 !== p[q].markerSize && (0 < p[q].markerSize || 0 < m.markerSize)) { var P = m.getMarkerProperties(q, g, r, b);
                                        l.push(P);
                                        S = Q(S);
                                        w && l.push({ x: g, y: r, ctx: e, type: P.type, size: P.size, color: S, borderColor: S, borderThickness: P.borderThickness }) }(p[q].indexLabel || m.indexLabel || p[q].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({
        ...
        n.prototype.renderStepArea = function(a) {
            ...
            function b() {
                D && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? B = C : 0 > a.axisY.viewportMaximum ? B = u.y1 : 0 < a.axisY.viewportMinimum && (B = C), f.lineTo(n, B), f.lineTo(D.x, B), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha = 1, w && (l.lineTo(n, B), l.lineTo(D.x,
                    B), l.closePath(), l.fill()), f.beginPath(), f.moveTo(n, t), l.beginPath(), l.moveTo(n, t), D = { x: n, y: t })
            }
            var e = a.targetCanvasCtx || this.plotArea.ctx,
                f = w ? this._preRenderCtx : e;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    if (0 < r.length) {
                        ...
                        for (; h < r.length; h++)
                            if (s = r[h].x.getTime ? r[h].x.getTime() : r[h].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))) {
                                var aa = t;
                                "number" !== typeof r[h].y ? (g.connectNullData || (c || d) || b(), c = !0) : (n = a.axisX.convertValueToPixel(s), t = a.axisY.convertValueToPixel(r[h].y), d || c ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || S === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = n, c = t, n = m.x, t = m.y, b(),
        ...
        n.prototype.renderStackedArea = function(a) {
            function d() { if (!(1 > k.length)) { for (0 < z.lineThickness && b.stroke(); 0 < k.length;) { var a = k.pop();
                        b.lineTo(a.x, a.y);
                        w && s.lineTo(a.x, a.y) }
                    b.closePath();
                ...
                for (B = 0; B < a.dataSeriesIndexes.length; B++) {
                    ...
                    if (0 < m.length) {
                        ...
                        b.lineWidth =
                            z.lineThickness;
                        C = "solid";
                        if (b.setLineDash) { var P = N(z.nullDataLineDashType, z.lineThickness);
                            C = z.lineDashType; var E = N(C, z.lineThickness);
                            b.setLineDash(E) }
                        for (var aa = !0, q = 0; q < m.length; q++) {
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !aa)))
                                if ("number" !== typeof fa.y) z.connectNullData || (aa || y) || d(), aa = !0;
                                else {
                                    g = a.axisX.convertValueToPixel(f);
                                    var ma = h[f] ? h[f] : 0;
                                    if (a.axisY.logarithmic ||
                                        a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) { p[f] = fa.y + (p[f] ? p[f] : 0); if (0 >= p[f] && a.axisY.logarithmic) continue;
                                        r = a.axisY.convertValueToPixel(p[f]) } else r = a.axisY.convertValueToPixel(fa.y), r -= ma;
                                    k.push({ x: g, y: n - ma });
                                    h[f] = n - r;
                                    y || aa ? (!y && z.connectNullData ? (b.setLineDash && (z.options.nullDataLineDashType || C === z.lineDashType && z.lineDashType !== z.nullDataLineDashType) && (y = k.pop(), C = k[k.length - 1], d(), b.moveTo(t.x, t.y), k.push(C), k.push(y), C = z.nullDataLineDashType, b.setLineDash(P)), b.lineTo(g,
                                        r), w && s.lineTo(g, r)) : (b.beginPath(), b.moveTo(g, r), w && (s.beginPath(), s.moveTo(g, r))), aa = y = !1) : (b.lineTo(g, r), w && s.lineTo(g, r), 0 == q % 250 && (d(), b.moveTo(g, r), w && s.moveTo(g, r), k.push({ x: g, y: n - ma })));
                                    t = { x: g, y: r };
                                    q < v.length - 1 && (S !== (v[q].lineColor || x) || C !== (v[q].lineDashType || z.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, r), k.push({ x: g, y: n - ma }), S = v[q].lineColor || x, b.strokeStyle = S, b.setLineDash && (v[q].lineDashType ? (C = v[q].lineDashType, b.setLineDash(N(C, z.lineThickness))) : (C = z.lineDashType, b.setLineDash(E))));
                                    if (0 <= z.dataPointIndexes[f]) { var F = z.dataPointIds[z.dataPointIndexes[f]];
                                        this._eventManager.objectMap[F] = { id: F, objectType: "dataPoint", dataSeriesIndex: D, dataPointIndex: z.dataPointIndexes[f], x1: g, y1: r } }
                                    0 <= z.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < z.markerSize) && (ma = z.getMarkerProperties(z.dataPointIndexes[f], g, r, b), l.push(ma), f = Q(F), w && l.push({ x: g, y: r, ctx: s, type: ma.type, size: ma.size, color: f, borderColor: f, borderThickness: ma.borderThickness }));
        ...
        n.prototype.renderStackedArea100 = function(a) {
            function d() {
                for (0 < z.lineThickness && b.stroke(); 0 < k.length;) { var a = k.pop();
                    b.lineTo(a.x, a.y);
                    w && C.lineTo(a.x, a.y) }
                b.closePath();
                b.globalAlpha = z.fillOpacity;
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null,
                    ...
                    p = [],
                    q = 0,
                    g, r, n, s, t, y = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                ...
                b.clip();
                w && (C.beginPath(), C.rect(l.x1, l.y1, l.width, l.height), C.clip());
                for (var e = [], B = 0; B < a.dataSeriesIndexes.length; B++) { var v = a.dataSeriesIndexes[B],
                        z = this.data[v],
                        x = z.dataPoints;
                    z.dataPointIndexes = []; for (q = 0; q < x.length; q++) v = x[q].x.getTime ? x[q].x.getTime() : x[q].x, z.dataPointIndexes[v] = q, e[v] || (m.push(v), e[v] = !0);
                    m.sort(Pa) }
                for (B = 0; B < a.dataSeriesIndexes.length; B++) {
                    v = a.dataSeriesIndexes[B];
                    z = this.data[v];
                    x = z.dataPoints;
                    s = !0;
                    e = z.id;
                    ...
                    if (0 < m.length) {
                        ...
                        t = "solid";
                        if (b.setLineDash) { var P = N(z.nullDataLineDashType, z.lineThickness);
                            t = z.lineDashType; var F = N(t, z.lineThickness);
                            b.setLineDash(F) }
                        for (var aa = !0, q = 0; q < m.length; q++) {
                            var f = m[q],
                                fa = null,
                                fa = 0 <= z.dataPointIndexes[f] ? x[z.dataPointIndexes[f]] : { x: f, y: null };
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !aa)))
                                if ("number" !== typeof fa.y) z.connectNullData ||
                                    ...
                                    g = a.axisX.convertValueToPixel(f);
                                    var ba = h[f] ? h[f] : 0;
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) { p[f] = ma + (p[f] ? p[f] : 0); if (0 >= p[f] && a.axisY.logarithmic) continue;
                                        r = a.axisY.convertValueToPixel(p[f]) } else r = a.axisY.convertValueToPixel(ma), r -= ba;
                                    k.push({ x: g, y: y - ba });
                                    h[f] = y - r;
                                    s || aa ? (!s && z.connectNullData ? (b.setLineDash && (z.options.nullDataLineDashType || t === z.lineDashType &&
                                        z.lineDashType !== z.nullDataLineDashType) && (s = k.pop(), t = k[k.length - 1], d(), b.moveTo(n.x, n.y), k.push(t), k.push(s), t = z.nullDataLineDashType, b.setLineDash(P)), b.lineTo(g, r), w && C.lineTo(g, r)) : (b.beginPath(), b.moveTo(g, r), w && (C.beginPath(), C.moveTo(g, r))), aa = s = !1) : (b.lineTo(g, r), w && C.lineTo(g, r), 0 == q % 250 && (d(), b.moveTo(g, r), w && C.moveTo(g, r), k.push({ x: g, y: y - ba })));
                                    n = { x: g, y: r };
                                    q < x.length - 1 && (S !== (x[q].lineColor || E) || t !== (x[q].lineDashType || z.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, r), k.push({
                                        x: g,
                                        y: y -
                                            ba
                                    }), S = x[q].lineColor || E, b.strokeStyle = S, b.setLineDash && (x[q].lineDashType ? (t = x[q].lineDashType, b.setLineDash(N(t, z.lineThickness))) : (t = z.lineDashType, b.setLineDash(F))));
                                    if (0 <= z.dataPointIndexes[f]) { var G = z.dataPointIds[z.dataPointIndexes[f]];
                                        this._eventManager.objectMap[G] = { id: G, objectType: "dataPoint", dataSeriesIndex: v, dataPointIndex: z.dataPointIndexes[f], x1: g, y1: r } }
                                    0 <= z.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < z.markerSize) && (ba = z.getMarkerProperties(q, g, r, b), u.push(ba), f = Q(G),
                                        w && u.push({ x: g, y: r, ctx: C, type: ba.type, size: ba.size, color: f, borderColor: f, borderThickness: ba.borderThickness }));
                    ...
                    if (m = a.dataSeriesIndexes[k], p = this.data[m], q = p.dataPoints, 0 < q.length)
                        for (c.strokeStyle = "#4572A7 ", e = 0; e < q.length; e++)
                            if (f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, !(f < a.axisX.dataInfo.viewPortMin ||
                                ...
                                var g = q[e].z,
                                    s = 2 * Math.max(Math.sqrt((u === h ? n / 2 : r + (n - r) / (u - h) * (g - h)) / Math.PI) << 0, 1),
                                ...
                                this._eventManager.objectMap[t] = { id: t, objectType: "dataPoint", dataSeriesIndex: m, dataPointIndex: e, x1: f, y1: l, size: s };
                                s = Q(t);
                                w && W.drawMarker(f, l, this._eventManager.ghostCtx, g.type, g.size, s, s, g.borderThickness);
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    var v = a.dataSeriesIndexes[n],
                        ...
                        y = t.dataPoints;
                    if (0 < y.length)
                        for (var C = 5 < r && t.bevelEnabled ? !0 : !1, u = 0; u < y.length; u++)
                            if (y[u].getTime ? g = y[u].x.getTime() : g = y[u].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(y[u].y) && y[u].y.length && "number" === typeof y[u].y[0] &&
                                "number" === typeof y[u].y[1] && "number" === typeof y[u].y[2] && "number" === typeof y[u].y[3]) {
                                h = a.axisX.convertValueToPixel(g);
                                k = a.axisY.convertValueToPixel(y[u].y[0]);
                                m = a.axisY.convertValueToPixel(y[u].y[1]);
                                ...
                                var B = h - r / 2 << 0,
                                    ...
                                    e = y[u].color ? y[u].color : t._colorSet[0],
                                    z = Math.round(Math.max(1, 0.15 * r)),
                                    x = 0 === z % 2 ? 0 : 0.5,
                                    E = t.dataPointIds[u];
                                this._eventManager.objectMap[E] = { id: E, objectType: "dataPoint", dataSeriesIndex: v, dataPointIndex: u, x1: B, y1: k, x2: D, y2: m, x3: h, y3: p, x4: h, y4: q, borderThickness: z, color: e };
                                c.strokeStyle = e;
                                c.beginPath();
                                c.lineWidth = z;
                                b.lineWidth = Math.max(z, 4);
                                "candlestick" === t.type ? (c.moveTo(h - x, m), c.lineTo(h - x, Math.min(k, q)), c.stroke(), c.moveTo(h - x, Math.max(k, q)), c.lineTo(h - x, p), c.stroke(), ca(c, B, Math.min(k, q), D, Math.max(k, q), y[u].y[0] <= y[u].y[3] ? t.risingColor : f, z, e, C, C, !1, !1, t.fillOpacity), w && (e = Q(E), b.strokeStyle = e, b.moveTo(h - x, m), b.lineTo(h - x, Math.min(k,
                                    q)), b.stroke(), b.moveTo(h - x, Math.max(k, q)), b.lineTo(h - x, p), b.stroke(), ca(b, B, Math.min(k, q), D, Math.max(k, q), e, 0, null, !1, !1, !1, !1))) : "ohlc" === t.type && (c.moveTo(h - x, m), c.lineTo(h - x, p), c.stroke(), c.beginPath(), c.moveTo(h, k), c.lineTo(B, k), c.stroke(), c.beginPath(), c.moveTo(h, q), c.lineTo(D, q), c.stroke(), w && (e = Q(E), b.strokeStyle = e, b.moveTo(h - x, m), b.lineTo(h - x, p), b.stroke(), b.beginPath(), b.moveTo(h, k), b.lineTo(B, k), b.stroke(), b.beginPath(), b.moveTo(h, q), b.lineTo(D, q), b.stroke()));
                                (y[u].indexLabel || t.indexLabel ||
                                    y[u].indexLabelFormatter || t.indexLabelFormatter) && this._indexLabels.push({ chartType: t.type, dataPoint: y[u], dataSeries: t, point: { x: B + (D - B) / 2, y: a.axisY.reversed ? p : m }, direction: 1, bounds: { x1: B, y1: Math.min(m, p), x2: D, y2: Math.max(m, p) }, color: e })
                            }
                }
        ...
        n.prototype.renderBoxAndWhisker = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null,
                    f = this.plotArea,
                    l = 0,
                    u, h, k, m, p, q, g, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1,
                ...
                for (var n = !1, n = !!a.axisY.reversed, v = 0; v < a.dataSeriesIndexes.length; v++) {
                    var t = a.dataSeriesIndexes[v],
                        ...
                        C = y.dataPoints;
                    if (0 < C.length)
                        for (var B = 5 < r && y.bevelEnabled ? !0 : !1, l = 0; l < C.length; l++)
                            if (C[l].getTime ? g = C[l].x.getTime() : g = C[l].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(C[l].y) && C[l].y.length && "number" === typeof C[l].y[0] && "number" === typeof C[l].y[1] && "number" === typeof C[l].y[2] && "number" === typeof C[l].y[3] && "number" === typeof C[l].y[4] && 5 === C[l].y.length) {
                                u = a.axisX.convertValueToPixel(g);
                                h = a.axisY.convertValueToPixel(C[l].y[0]);
                                k = a.axisY.convertValueToPixel(C[l].y[1]);
                                m = a.axisY.convertValueToPixel(C[l].y[2]);
                                p = a.axisY.convertValueToPixel(C[l].y[3]);
                                q = a.axisY.convertValueToPixel(C[l].y[4]);
                                var D = u - r / 2 << 0,
                                    z = u + r / 2 << 0,
                                    e = C[l].color ? C[l].color : y._colorSet[0],
                                    x = Math.round(Math.max(1, 0.15 * r)),
                                    E = 0 === x % 2 ? 0 : 0.5,
                                    S = C[l].whiskerColor ? C[l].whiskerColor : C[l].color ? y.whiskerColor ? y.whiskerColor : C[l].color : y.whiskerColor ? y.whiskerColor : e,
                                    P = "number" === typeof C[l].whiskerThickness ? C[l].whiskerThickness : "number" === typeof y.options.whiskerThickness ? y.whiskerThickness : x,
                                    F = C[l].whiskerDashType ? C[l].whiskerDashType : y.whiskerDashType,
                                    aa = s(C[l].whiskerLength) ? s(y.options.whiskerLength) ? r : y.whiskerLength : C[l].whiskerLength,
                                    aa = "number" === typeof aa ? 0 >= aa ? 0 : aa >= r ? r : aa : "string" === typeof aa ? parseInt(aa) * r / 100 > r ? r : parseInt(aa) * r / 100 : r,
                                    fa = 1 === Math.round(P) % 2 ? 0.5 : 0,
                                    ma = C[l].stemColor ? C[l].stemColor : C[l].color ? y.stemColor ? y.stemColor : C[l].color : y.stemColor ? y.stemColor : e,
                                    ba = "number" === typeof C[l].stemThickness ? C[l].stemThickness : "number" === typeof y.options.stemThickness ? y.stemThickness : x,
                                    G = 1 === Math.round(ba) % 2 ? 0.5 : 0,
                                    H = C[l].stemDashType ? C[l].stemDashType :
                                    y.stemDashType,
                                    J = C[l].lineColor ? C[l].lineColor : C[l].color ? y.lineColor ? y.lineColor : C[l].color : y.lineColor ? y.lineColor : e,
                                    M = "number" === typeof C[l].lineThickness ? C[l].lineThickness : "number" === typeof y.options.lineThickness ? y.lineThickness : x,
                                    T = C[l].lineDashType ? C[l].lineDashType : y.lineDashType,
                                    K = 1 === Math.round(M) % 2 ? 0.5 : 0,
                                    R = y.upperBoxColor,
                                    wa = y.lowerBoxColor,
                                    ra = s(y.options.fillOpacity) ? 1 : y.fillOpacity,
                                    O = y.dataPointIds[l];
                                ...
                                c.save();
                                0 < ba && (c.beginPath(), c.strokeStyle = ma, c.lineWidth = ba, c.setLineDash && c.setLineDash(N(H, ba)), c.moveTo(u - G, k), c.lineTo(u - G, h), c.stroke(), c.moveTo(u - G, p), c.lineTo(u - G, m), c.stroke());
                                c.restore();
                                b.lineWidth = Math.max(x, 4);
                                c.beginPath();
                                ca(c, D, Math.min(q, k), z, Math.max(k, q), wa, 0, e, n ? B : !1, n ? !1 : B, !1, !1, ra);
                                c.beginPath();
                                ca(c, D, Math.min(m, q), z, Math.max(q, m), R, 0, e, n ? !1 : B, n ? B : !1, !1, !1, ra);
                                c.beginPath();
                                c.lineWidth = x;
                                c.strokeStyle = e;
                                ...
                                c.stroke();
                                c.save();
                                0 < M && (c.beginPath(), c.globalAlpha = 1, c.setLineDash && c.setLineDash(N(T, M)), c.strokeStyle = J, c.lineWidth = M, c.moveTo(D, q - K), c.lineTo(z, q - K), c.stroke());
                                c.restore();
                                c.save();
                                ...
                                (C[l].indexLabel || y.indexLabel || C[l].indexLabelFormatter ||
                                    y.indexLabelFormatter) && this._indexLabels.push({ chartType: y.type, dataPoint: C[l], dataSeries: y, point: { x: D + (z - D) / 2, y: a.axisY.reversed ? h : p }, direction: 1, bounds: { x1: D, y1: Math.min(h, p), x2: z, y2: Math.max(h, p) }, color: e })
                            }
                }
                w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
                        ...
                        for (var r =
                            ...
                            if (g[f].getTime ? h = g[f].x.getTime() : h = g[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !s(g[f].y) && g[f].y.length && "number" === typeof g[f].y[0] && "number" === typeof g[f].y[1]) {
                                ...
                                if (l > u) { var t = l;
                                    ...
                                    u = t }
                                t = q.dataPointIds[f];
                                this._eventManager.objectMap[t] = { id: t, objectType: "dataPoint", dataSeriesIndex: p, dataPointIndex: f, x1: n, y1: l, x2: v, y2: u };
                                ca(c, n, l, v, u, b, 0, b, r, r, !1, !1, q.fillOpacity);
                                b = Q(t);
                                w && ca(this._eventManager.ghostCtx, n, l, v, u, b, 0, null, !1, !1, !1, !1);
                                if (g[f].indexLabel || q.indexLabel || g[f].indexLabelFormatter || q.indexLabelFormatter) this._indexLabels.push({
                                    chartType: "rangeColumn",
                                    dataPoint: g[f],
                                    dataSeries: q,
                                    indexKeyword: 0,
                                    point: { x: n + (v - n) / 2, y: g[f].y[1] >= g[f].y[0] ? u : l },
                                    direction: g[f].y[1] >= g[f].y[0] ? -1 : 1,
                                    bounds: { x1: n, y1: Math.min(l, u), x2: v, y2: Math.max(l, u) },
                                    color: b
                                }), this._indexLabels.push({ chartType: "rangeColumn", dataPoint: g[f], dataSeries: q, indexKeyword: 1, point: { x: n + (v - n) / 2, y: g[f].y[1] >= g[f].y[0] ? l : u }, direction: g[f].y[1] >= g[f].y[0] ? 1 : -1, bounds: { x1: n, y1: Math.min(l, u), x2: v, y2: Math.max(l, u) }, color: b })
                            }
                }
                    ...
                    for (var y = 0; y < a.dataSeriesIndexes.length; y++) {
                        ...
                        if (z)
                            for (e = B._linkedSeries.id, t = 0; t < e; t++) !this.data[t].type.match(/(bar|column)/ig) ||
                                !this.data[t].visible || this.data[t].type.match(/(stacked)/ig) && E || (this.data[t].type.match(/(range)/ig) && (f = !0), E++);
                        e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                        u = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (z ? v : 1))) << 0 : 0.3 * this.width;
                        f && (u = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth :
                            b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (z ? v : 1))) << 0 : 0.03 * this.width);
                        t = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * ((b ? l.height : l.width) * (a.axisX.logarithmic ? Math.log(n) / Math.log(a.axisX.range) : Math.abs(n) / Math.abs(a.axisX.range)) / (z ? v : 1)) << 0;
                        ...
                        t > u && (t = u);
                        if (0 < D.length)
                            for (var F = B._colorSet, u = 0; u < D.length; u++) {
                                var e = B.lineColor = B.options.color ? B.options.color : F[0],
                                    S = {
                                        color: D[u].whiskerColor ? D[u].whiskerColor : D[u].color ? B.whiskerColor ? B.whiskerColor : D[u].color : B.whiskerColor ? B.whiskerColor : e,
                                        thickness: s(D[u].whiskerThickness) ? B.whiskerThickness : D[u].whiskerThickness,
                                        dashType: D[u].whiskerDashType ? D[u].whiskerDashType : B.whiskerDashType,
                                        length: s(D[u].whiskerLength) ? s(B.options.whiskerLength) ? t : B.options.whiskerLength : D[u].whiskerLength,
                                        trimLength: s(D[u].whiskerLength) ? s(B.options.whiskerLength) ? 50 : 0 : 0
                                    };
                                ...
                                var P = {
                                    color: D[u].stemColor ? D[u].stemColor : D[u].color ? B.stemColor ? B.stemColor : D[u].color : B.stemColor ? B.stemColor : e,
                                    thickness: D[u].stemThickness ? D[u].stemThickness : B.stemThickness,
                                    dashType: D[u].stemDashType ?
                                        D[u].stemDashType : B.stemDashType
                                };
                                P.thickness = "number" === typeof P.thickness ? 0 > P.thickness ? 0 : Math.round(P.thickness) : 2;
                                D[u].getTime ? r = D[u].x.getTime() : r = D[u].x;
                                if (!(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax) && !s(D[u].y) && D[u].y.length && "number" === typeof D[u].y[0] && "number" === typeof D[u].y[1]) {
                                    var ja = a.axisX.convertValueToPixel(r);
                                    b ? k = ja : h = ja;
                                    ja = a.axisY.convertValueToPixel(D[u].y[0]);
                                    b ? m = ja : q = ja;
                                    ja = a.axisY.convertValueToPixel(D[u].y[1]);
                                    b ? p = ja : g = ja;
                                    b ? (q = a.axisX.reversed ? k + (z ? v :
                                        1) * t / 2 - (z ? E - 1 : 0) * t << 0 : k - (z ? v : 1) * t / 2 + (z ? E - 1 : 0) * t << 0, g = a.axisX.reversed ? q - t << 0 : q + t << 0) : (m = a.axisX.reversed ? h + (z ? v : 1) * t / 2 - (z ? E - 1 : 0) * t << 0 : h - (z ? v : 1) * t / 2 + (z ? E - 1 : 0) * t << 0, p = a.axisX.reversed ? m - t << 0 : m + t << 0);
                                    !b && q > g && (ja = q, q = g, g = ja);
                                    b && m > p && (ja = m, m = p, p = ja);
                                    ja = B.dataPointIds[u];
                                    this._eventManager.objectMap[ja] = { id: ja, objectType: "dataPoint", dataSeriesIndex: C, dataPointIndex: u, x1: Math.min(m, p), y1: Math.min(q, g), x2: Math.max(p, m), y2: Math.max(g, q), isXYSwapped: b, stemProperties: P, whiskerProperties: S };
                                    x(c, Math.min(m, p),
                                        Math.min(q, g), Math.max(p, m), Math.max(g, q), e, S, P, b);
                                    w && x(this._eventManager.ghostCtx, m, q, p, g, e, S, P, b);
                                    if (D[u].indexLabel || B.indexLabel || D[u].indexLabelFormatter || B.indexLabelFormatter) this._indexLabels.push({ chartType: "error", dataPoint: D[u], dataSeries: B, indexKeyword: 0, point: { x: b ? D[u].y[1] >= D[u].y[0] ? m : p : m + (p - m) / 2, y: b ? q + (g - q) / 2 : D[u].y[1] >= D[u].y[0] ? g : q }, direction: D[u].y[1] >= D[u].y[0] ? -1 : 1, bounds: { x1: b ? Math.min(m, p) : m, y1: b ? q : Math.min(q, g), x2: b ? Math.max(m, p) : p, y2: b ? g : Math.max(q, g) }, color: e, axisSwapped: b }),
                                        this._indexLabels.push({ chartType: "error", dataPoint: D[u], dataSeries: B, indexKeyword: 1, point: { x: b ? D[u].y[1] >= D[u].y[0] ? p : m : m + (p - m) / 2, y: b ? q + (g - q) / 2 : D[u].y[1] >= D[u].y[0] ? q : g }, direction: D[u].y[1] >= D[u].y[0] ? 1 : -1, bounds: { x1: b ? Math.min(m, p) : m, y1: b ? q : Math.min(q, g), x2: b ? Math.max(m, p) : p, y2: b ? g : Math.max(q, g) }, color: e, axisSwapped: b })
                                }
                            }
                    }
                    ...
                    if (0 < r.length) {
                        ...
                        for (f = 0; f < r.length; f++)
                            if (r[f].getTime ? k = r[f].x.getTime() : k = r[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !s(r[f].y) && r[f].y.length && "number" === typeof r[f].y[0] && "number" === typeof r[f].y[1]) {
                                ...
                                l > u && (b = l, l = u, u = b);
                                b = r[f].color ? r[f].color : g._colorSet[f % g._colorSet.length];
                                ca(c, l, h, u, v, b, 0, null, n, !1, !1, !1, g.fillOpacity);
                                b = g.dataPointIds[f];
                                this._eventManager.objectMap[b] = {
                                    id: b,
                                    objectType: "dataPoint",
                                ...
                                b = Q(b);
                                w && ca(this._eventManager.ghostCtx, l, h, u, v, b, 0, null, !1, !1, !1, !1);
                                if (r[f].indexLabel || g.indexLabel || r[f].indexLabelFormatter || g.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeBar", dataPoint: r[f], dataSeries: g, indexKeyword: 0, point: { x: r[f].y[1] >= r[f].y[0] ? l : u, y: h + (v - h) / 2 }, direction: r[f].y[1] >= r[f].y[0] ? -1 : 1, bounds: { x1: Math.min(l, u), y1: h, x2: Math.max(l, u), y2: v }, color: b }), this._indexLabels.push({
                                    chartType: "rangeBar",
                                    dataPoint: r[f],
                                    dataSeries: g,
                                    indexKeyword: 1,
                                    ...
                                    bounds: { x1: Math.min(l, u), y1: h, x2: Math.max(l, u), y2: v },
                                    color: b
                                })
                            }
                    }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var u = 0; u < a.dataSeriesIndexes.length; u++) {
                    ...
                    var f = [],
                        ...
                        r, n, s, t, y = null;
                    if (0 < p.length) {
                        var C = m._colorSet[g % m._colorSet.length],
                            v = m.lineColor = m.options.lineColor || C,
                            D = v;
                        b.fillStyle = C;
                        b.strokeStyle = v;
                        b.lineWidth = m.lineThickness;
                        ...
                        for (var S = !0; g < p.length; g++)
                            if (t = p[g].x.getTime ? p[g].x.getTime() : p[g].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !S)))
                                if (null !== p[g].y && p[g].y.length && "number" === typeof p[g].y[0] && "number" === typeof p[g].y[1]) {
                                    ...
                                    q || S ? (m.connectNullData && !q ? (b.setLineDash && (m.options.nullDataLineDashType || z === m.lineDashType &&
                                    ...
                                    t = m.dataPointIds[g];
                                    this._eventManager.objectMap[t] = { id: t, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: g, x1: r, y1: n, y2: s };
                                    g < p.length -
                                        1 && (D !== (p[g].lineColor || v) || z !== (p[g].lineDashType || m.lineDashType)) && (d(), D = p[g].lineColor || v, h[h.length - 1].newStrokeStyle = D, b.strokeStyle = D, b.setLineDash && (p[g].lineDashType ? (z = p[g].lineDashType, h[h.length - 1].newLineDashArray = N(z, m.lineThickness), b.setLineDash(h[h.length - 1].newLineDashArray)) : (z = m.lineDashType, h[h.length - 1].newLineDashArray = E, b.setLineDash(E))));
                                    if (0 !== p[g].markerSize && (0 < p[g].markerSize || 0 < m.markerSize)) {
                                        var P = m.getMarkerProperties(g, r, s, b);
                                        f.push(P);
                                        var F = Q(t);
                                        w && f.push({
                                            x: r,
                                        ...
                                        P = m.getMarkerProperties(g, r, n, b);
                                        f.push(P);
                                        F = Q(t);
                                        w && f.push({ x: r, y: n, ctx: e, type: P.type, size: P.size, color: F, borderColor: F, borderThickness: P.borderThickness })
                                    }
                                    if (p[g].indexLabel || m.indexLabel || p[g].indexLabelFormatter || m.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeArea", dataPoint: p[g], dataSeries: m, indexKeyword: 0, point: { x: r, y: n }, direction: p[g].y[0] > p[g].y[1] === a.axisY.reversed ? -1 : 1, color: C }), this._indexLabels.push({
                                        chartType: "rangeArea",
                                        dataPoint: p[g],
                                        dataSeries: m,
                                        indexKeyword: 1,
                ...
                for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                    ...
                    if (0 < m.length) {
                        var t = k._colorSet[p % k._colorSet.length],
                            y = k.lineColor = k.options.lineColor || t,
                            C = y;
                        b.fillStyle = t;
                        b.lineWidth = k.lineThickness;
                        var B = "solid",
                            D;
                        if (b.setLineDash) { var z = N(k.nullDataLineDashType, k.lineThickness),
                                B = k.lineDashType;
                            D = N(B, k.lineThickness) }
                        for (g = !1; p < m.length; p++)
                            if (q = m[p].x.getTime ? m[p].x.getTime() : m[p].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData ||
                                ...
                                if (null !== m[p].y && m[p].y.length && "number" === typeof m[p].y[0] && "number" === typeof m[p].y[1]) {
                                    ...
                                    s[s.length] = { x: q, y: g };
                                    x[x.length] = { x: q, y: r };
                                    p < m.length - 1 && (C !== (m[p].lineColor || y) || B !== (m[p].lineDashType || k.lineDashType)) && (C = m[p].lineColor || y, s[s.length -
                                        1].newStrokeStyle = C, b.setLineDash && (m[p].lineDashType ? (B = m[p].lineDashType, s[s.length - 1].newLineDashArray = N(B, k.lineThickness)) : (B = k.lineDashType, s[s.length - 1].newLineDashArray = D)));
                                    if (0 !== m[p].markerSize && (0 < m[p].markerSize || 0 < k.markerSize)) {
                                        var F = k.getMarkerProperties(p, q, g, b);
                                        f.push(F);
                                        var S = Q(E);
                                        w && f.push({ x: q, y: g, ctx: e, type: F.type, size: F.size, color: S, borderColor: S, borderThickness: F.borderThickness });
                                    ...
                                    if (m[p].indexLabel || k.indexLabel || m[p].indexLabelFormatter || k.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: m[p], dataSeries: k, indexKeyword: 0, point: { x: q, y: g }, direction: m[p].y[0] <= m[p].y[1] ? -1 : 1, color: t }), this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: m[p], dataSeries: k, indexKeyword: 1, point: { x: q, y: r }, direction: m[p].y[0] <= m[p].y[1] ? 1 : -1, color: t });
                                    g = !1
                                } else 0 < p && !g && (k.connectNullData ? b.setLineDash &&
                                    (0 < s.length && (k.options.nullDataLineDashType || !m[p - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = z, B = k.nullDataLineDashType) : (d(D, y), s = [], x = [])), g = !0;
                        d(D, y);
                        W.drawMarkers(f)
                    }
                }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                    ...
                    var t = "number" === typeof s.options.lineThickness ? Math.round(s.lineThickness) : 1,
                        y = 1 === Math.round(t) % 2 ? -0.5 : 0;
                    if (0 < v.length)
                        for (var C = 5 < q && s.bevelEnabled ? !0 : !1, B = !1, x = null, z = null, l = 0; l < v.length; l++)
                            if (v[l].getTime ?
                                m = v[l].x.getTime() : m = v[l].x, "number" !== typeof v[l].y) { if (0 < l && !B && s.connectNullData) var E = s.options.nullDataLineDashType || !v[l - 1].lineDashType ? s.nullDataLineDashType : v[l - 1].lineDashType;
                                B = !0 } else {
                                ...
                                var S = v[l].color ? v[l].color : 0 < v[l].y ? s.risingColor : s.fallingColor;
                                ca(c, h, n, F, k, S, 0, S, C, C, !1, !1, s.fillOpacity);
                                e = Q(e);
                                w && ca(this._eventManager.ghostCtx, h, n, F, k, e, 0, null, !1, !1, !1, !1);
                                var P, S = h;
                                P = "undefined" !== typeof v[l].isIntermediateSum && !0 === v[l].isIntermediateSum || "undefined" !== typeof v[l].isCumulativeSum && !0 === v[l].isCumulativeSum ? 0 < v[l].y ? n : k : 0 < v[l].y ? k : n;
                                0 < l && x && (!B || s.connectNullData) && (B && c.setLineDash && c.setLineDash(N(E, t)), c.beginPath(), c.moveTo(x, z - y), c.lineTo(S, P - y), 0 < t && c.stroke(), w && (b.beginPath(), b.moveTo(x, z - y), b.lineTo(S, P - y), 0 < t && b.stroke()));
                                B = !1;
                                x = F;
                                z = 0 < v[l].y ? n : k;
                                S = v[l].lineDashType ? v[l].lineDashType : s.options.lineDashType ? s.options.lineDashType :
                                    "shortDash";
        ...
        var X = function(a, d, c, b, e, f, l, h, n) {
            if (!(0 > c)) {
        ...
        n.prototype.renderPie = function(a) {
            function d() {
                if (k && m) {
                    for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < m.length; e++) {
                        ...
                        if (k.indexLabelFormatter || f.indexLabelFormatter) u = { chart: n.options, dataSeries: k, dataPoint: f, total: p.total, percent: p.percent };
                        p = f.indexLabelFormatter ? f.indexLabelFormatter(u) :
                            f.indexLabel ? n.replaceKeywordsWithValue(f.indexLabel, f, k, e) : k.indexLabelFormatter ? k.indexLabelFormatter(u) : k.indexLabel ? n.replaceKeywordsWithValue(k.indexLabel, f, k, e) : f.label ? f.label : "";
                        n._eventManager.objectMap[l] = h;
                        h.center = { x: C.x, y: C.y };
                        h.y = f.y;
                        h.radius = z;
                    ...
                    l = f = 0;
                    p = !1;
                    for (e = 0; e < m.length; e++) h = g[(c + e) % m.length], 1 < a && (h.midAngle > Math.PI / 2 - t && h.midAngle < Math.PI / 2 + t) && (f <= a / 2 && !p ? (h.hemisphere = "right", f++) : (h.hemisphere = "left", p = !0));
                    p = !1;
                    for (e = 0; e < m.length; e++) h = g[(d + e) % m.length], 1 < b && (h.midAngle > 3 * Math.PI / 2 - t && h.midAngle < 3 * Math.PI / 2 + t) && (l <= b / 2 && !p ? (h.hemisphere = "left", l++) : (h.hemisphere = "right", p = !0))
                }
            }
                ...
                for (b = 0; b < m.length; b++) {
                    ...
                    if (d > c) {
                        var e = 0.07 * z * Math.cos(g[b].midAngle),
                            ...
                            l = !1;
                        if (m[b].exploded) { if (1E-9 < Math.abs(g[b].center.x - (C.x + e)) || 1E-9 < Math.abs(g[b].center.y - (C.y + f))) g[b].center.x = C.x + e * a, g[b].center.y = C.y + f * a, l = !0 } else if (0 < Math.abs(g[b].center.x - C.x) || 0 < Math.abs(g[b].center.y - C.y)) g[b].center.x = C.x + e * (1 - a), g[b].center.y = C.y + f * (1 - a),
                            l = !0;
                        l && (e = {}, e.dataSeries = k, e.dataPoint = k.dataPoints[b], e.index = b, n.toolTip.highlightObjects([e]));
                        X(n.plotArea.ctx, g[b].center, g[b].radius, m[b].color ? m[b].color : k._colorSet[b % k._colorSet.length], k.type, c, d, k.fillOpacity, g[b].percentInnerRadius)
                    }
                }
                a = n.plotArea.ctx;
                a.save();
            ...
            function e(a) { for (var c = null, d = 1; d < m.length; d++)
            ...
            function f(a, c, d) {
                ...
                if (0 <= a && a < m.length) {
                    ...
                    l = 0;
                    l = "right" === p.hemisphere ? C.x + Math.sqrt(Math.pow(w, 2) - Math.pow(c - C.y, 2)) : C.x - Math.sqrt(Math.pow(w, 2) - Math.pow(c - C.y, 2));
                    u = C.x + z * Math.cos(p.midAngle);
                    q = C.y + z * Math.sin(p.midAngle);
                    q = Math.sqrt(Math.pow(l - u, 2) + Math.pow(c - q, 2));
                    u = Math.acos(z / w);
                    q = Math.acos((w * w + z * z - q * q) / (2 * z * w));
                    c = q < u ? c - p.indexLabelTextBlock.y : 0;
                    l = null;
                    for (h = 1; h < m.length; h++)
                        if (l = (a - h + g.length) % g.length, g[l].hemisphere !== g[a].hemisphere) { l = null; break } else if (g[l].indexLabelText && g[l].hemisphere ===
                    ...
                    q = e(a);
                    h = l = 0;
                    0 > c ? (h = "right" === p.hemisphere ? u : q, k = c, null !== h && (u = -c, c = p.indexLabelTextBlock.y - p.indexLabelTextBlock.height / 2 - (g[h].indexLabelTextBlock.y + g[h].indexLabelTextBlock.height / 2), c - u < r && (l = -u, h = f(h, l, d + 1), +h.toFixed(y) > +l.toFixed(y) && (k = c > r ? -(c - r) : -(u - (h - l)))))) : 0 < c && (h = "right" === p.hemisphere ?
                        q : u, k = c, null !== h && (u = c, c = g[h].indexLabelTextBlock.y - g[h].indexLabelTextBlock.height / 2 - (p.indexLabelTextBlock.y + p.indexLabelTextBlock.height / 2), c - u < r && (l = u, h = f(h, l, d + 1), +h.toFixed(y) < +l.toFixed(y) && (k = c > r ? c - r : u - (l - h)))));
                    k && (d = p.indexLabelTextBlock.y + k, c = 0, c = "right" === p.hemisphere ? C.x + Math.sqrt(Math.pow(w, 2) - Math.pow(d - C.y, 2)) : C.x - Math.sqrt(Math.pow(w, 2) - Math.pow(d - C.y, 2)), p.midAngle > Math.PI / 2 - t && p.midAngle < Math.PI / 2 + t ? (l = (a - 1 + g.length) % g.length, l = g[l], a = g[(a + 1 + g.length) % g.length], "left" === p.hemisphere &&
                        ...
                        15)), p.indexLabelTextBlock.y = d, p.indexLabelTextBlock.x = c, p.indexLabelAngle = Math.atan2(p.indexLabelTextBlock.y - C.y, p.indexLabelTextBlock.x - C.x))
                }
                return k
            }
            ...
            function l() {
                ...
                for (var c = a = 0, d = 0, l = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                    if (k.radius || !k.radius && "undefined" !== typeof k.innerRadius && null !== k.innerRadius && z - d <= E) l = !1;
                    l && (z -= d);
                    d = 0;
                    if ("inside" !== k.indexLabelPlacement) {
                        ...
                        for (a = 0; a < m.length; a++) {
                            var h =
                                g[a];
                            h.indexLabelTextBlock.x = C.x + w * Math.cos(h.midAngle);
                            h.indexLabelTextBlock.y = C.y + w * Math.sin(h.midAngle);
                            h.indexLabelAngle = h.midAngle;
                            h.radius = z;
                            h.percentInnerRadius = F
                        }
                        for (var u, s, a = 0; a < m.length; a++) {
                            var h = g[a],
                                t = e(a);
                            if (null !== t) {
                                u = g[a];
                                ...
                                if (0 > B) {
                                    ...
                                    var x = -1 * (B - s),
                                        H = D = 0;
                                    "right" === h.hemisphere ? (D = f(a, s), x = -1 * (B - D), H = f(t, x), +H.toFixed(y) <
                                        +x.toFixed(y) && +D.toFixed(y) <= +s.toFixed(y) && f(a, -(x - H))) : (D = f(t, s), x = -1 * (B - D), H = f(a, x), +H.toFixed(y) < +x.toFixed(y) && +D.toFixed(y) <= +s.toFixed(y) && f(t, -(x - H)))
                                }
                            }
                        }
                    } else
                        for (a = 0; a < m.length; a++) h = g[a], w = "pie" === k.type ? 0.7 * z : 0.8 * z, t = C.x + w * Math.cos(h.midAngle), s = C.y + w * Math.sin(h.midAngle), h.indexLabelTextBlock.x = t, h.indexLabelTextBlock.y = s;
                    for (a = 0; a < m.length; a++)
                    ...
                    var K = function(a,
                        b, c) { for (var d = [], e = 0; d.push(g[b]), b !== c; b = (b + 1 + m.length) % m.length);
                            ...
                            if (f = !1, u = g[k], u.indexLabelText) {
                                ...
                                if (null !== l) {
                                    ...
                                    if (q = 0 > B) {
                                        ...
                                        var n = u.indexLabelTextBlock.y - u.indexLabelTextBlock.height /
                                            2,
                                            r = u.indexLabelTextBlock.y + u.indexLabelTextBlock.height / 2,
                                            t = h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2,
                                            s = h.indexLabelTextBlock.x + h.indexLabelTextBlock.width,
                                            A = h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2;
                                        q = u.indexLabelTextBlock.x + u.indexLabelTextBlock.width < h.indexLabelTextBlock.x - p || q > s + p || n > A + p || r < t - p ? !1 : !0
                                    }
                                    q ? (0 > a && (a = k), l !== a && (c = l, d += -B), 0 === k % Math.max(m.length / 10, 3) && (f = !0)) : f = !0;
            ...
            function h() {
                ...
                if (n.subtitles)
                    for (var a = 0; a < n.subtitles.length; a++) { var b = n.subtitles[a];
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var k =
                    ...
                    B = 0;
                a = !1;
                for (var x = 0; x < m.length; x++) B += Math.abs(m[x].y), !a && ("undefined" !== typeof m[x].indexLabel && null !== m[x].indexLabel && 0 < m[x].indexLabel.toString().length) && (a = !0), !a && ("undefined" !== typeof m[x].label && null !== m[x].label && 0 < m[x].label.toString().length) && (a = !0);
                if (0 !== B) {
                    ...
                    var E = "undefined" !== typeof k.innerRadius && null !== k.innerRadius ? Ra(k.innerRadius, z) : 0.7 * z;
                    k.radius = z;
                    ...
                    this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function(a) {
                        ...
                        for (var b = g[0].startAngle + 2 * Math.PI * a, c = 0; c < m.length; c++) {
                            ...
                            e > d && X(n.plotArea.ctx, g[c].center, g[c].radius, l, k.type, d, e, k.fillOpacity, g[c].percentInnerRadius);
                            if (f) break
                        }
                        h();
                        n.dispatchEvent("dataAnimationIterationEnd", { chart: n });
                        1 <= a && n.dispatchEvent("dataAnimationEnd", { chart: n })
                    }, function() { n.disableToolTip = !1;
                        n._animator.animate(0, n.animatedRender ? 500 : 0, function(a) { c(a);
                            h();
                            n.dispatchEvent("dataAnimationIterationEnd", { chart: n }) });
                        n.dispatchEvent("dataAnimationEnd", { chart: n }) })
                }
        ...
        var pa = function(a, d, c, b) { "undefined" === typeof c && (c = 1);
        ...
        n.prototype.renderFunnel =
            function(a) {
                function d() { for (var a = 0, b = [], c = 0; c < y.length; c++) { if ("undefined" === typeof y[c].y) return -1;
                        y[c].y = "number" === typeof y[c].y ? y[c].y : 0;
                        a += Math.abs(y[c].y) } if (0 === a) return -1; for (c = b[0] = 0; c < y.length; c++) b.push(Math.abs(y[c].y) * E / a); return b }
                ...
                function c() {
                    ...
                    f = Math.abs(f);
                    f = d + f;
                    for (var d = [], g = 0, k = 0; k < y.length; k++) { if ("undefined" === typeof y[k].y) return -1;
                        y[k].y = "number" === typeof y[k].y ? y[k].y : 0;
                        g += Math.abs(y[k].y) }
                    if (0 ===
                        g) return -1;
                    for (var l = d[0] = 0, h = 0, m, p, b = b - a, l = !1, k = 0; k < y.length; k++) a = Math.abs(y[k].y) * f / g, l ? m = 0 == Number(c.toFixed(3)) ? 0 : a / c : (p = $ * $ * b * b - 4 * Math.abs($) * a, 0 > p ? (p = c, l = (b + p) * (e - h) / 2, a -= l, m = e - h, h += e - h, m += 0 == p ? 0 : a / p, h += a / p, l = !0) : (m = (Math.abs($) * b - Math.sqrt(p)) / 2, p = b - 2 * m / Math.abs($), h += m, h > e && (h -= m, p = c, l = (b + p) * (e - h) / 2, a -= l, m = e - h, h += e - h, m += a / p, h += a / p, l = !0), b = p)), d.push(m);
                    return d
                }

                function b() {
                    if (t && y) {
                        for (var a, b, c, d, e, f, k, l, h, m, p, q, u, n, r, A = [], v = [], C = { percent: null, total: null }, B = null, z = 0; z < y.length; z++) r = O[z],
                            r = "undefined" !== typeof r.x5 ? (r.y2 + r.y4) / 2 : (r.y2 + r.y3) / 2, r = g(r).x2 + 1, A[z] = J - r - V;
                        r = 0.5 * V;
                        for (var z = 0, D = y.length - 1; z < y.length || 0 <= D; z++, D--) {
                            b = t.reversed ? y[D] : y[z];
                            a = b.color ? b.color : t.reversed ? t._colorSet[(y.length - 1 - z) % t._colorSet.length] : t._colorSet[z % t._colorSet.length];
                            c = b.indexLabelPlacement || t.indexLabelPlacement || "outside";
                            n = b.indexLabelTextAlign || t.indexLabelTextAlign || "left";
                            ...
                            u = t.dataPointIds[z];
                            x._eventManager.objectMap[u] = { id: u, objectType: "dataPoint", dataPointIndex: z, dataSeriesIndex: 0, funnelSection: O[t.reversed ? y.length - 1 - z : z] };
                            ...
                            u = b.indexLabelMaxWidth ? b.indexLabelMaxWidth :
                                t.options.indexLabelMaxWidth ? t.indexLabelMaxWidth : A[z];
                            if (u > A[z] || 0 > u) u = A[z];
                            v[z] = "inside" === t.indexLabelPlacement ? O[z].height : !1;
                            C = x.getPercentAndTotal(t, b);
                            if (t.indexLabelFormatter || b.indexLabelFormatter) B = { chart: x.options, dataSeries: t, dataPoint: b, total: C.total, percent: C.percent };
                            b = b.indexLabelFormatter ? b.indexLabelFormatter(B) : b.indexLabel ? x.replaceKeywordsWithValue(b.indexLabel, b, t, z) : t.indexLabelFormatter ? t.indexLabelFormatter(B) : t.indexLabel ? x.replaceKeywordsWithValue(t.indexLabel, b, t, z) : b.label ?
                                b.label : "";
                            0 >= m && (m = 0);
                            1E3 > u && 1E3 - u < r && (u += 1E3 - u);
                            R.roundRect || Aa(R);
                            c = new ia(R, { fontSize: f, fontFamily: l, fontColor: e, fontStyle: k, fontWeight: h, horizontalAlign: c, textAlign: n, backgroundColor: d, maxWidth: u, maxHeight: !1 === v[z] ? q ? 4.28571429 * f : 1.5 * f : v[z], text: b, padding: da });
                            c.measureText();
                            I.push({ textBlock: c, id: t.reversed ? D : z, isDirty: !1, lineColor: a, lineThickness: m, lineDashType: p, height: c.height < c.maxHeight ? c.height : c.maxHeight, width: c.width < c.maxWidth ? c.width : c.maxWidth })
                        }
                    }
                }
                ...
                function e() {
                    ...
                    e = !1;
                    c = 0;
                    for (var g, k = J - Z - V / 2, k = t.options.indexLabelMaxWidth ? t.indexLabelMaxWidth > k ? k : t.indexLabelMaxWidth : k, l = I.length - 1; 0 <= l; l--) { g = y[I[l].id];
                        c = I[l];
                        d = c.textBlock;
                        ...
                        f.push(c) }
                    if (e)
                        for (l = I.length - 1; 0 <= l; l--) a = O[l], I[l].textBlock.maxWidth = f[f.length - (l + 1)], I[l].textBlock.measureText(), I[l].textBlock.x = J - k, c = I[l].textBlock.height < I[l].textBlock.maxHeight ? I[l].textBlock.height :
                ...
                function f() {
                    ...
                    if ("inside" !== t.indexLabelPlacement)
                        for (var e = 0; e < O.length; e++) 0 == I[e].textBlock.text.length ? I[e].isDirty = !0 : (a = O[e], c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2, b = t.reversed ? "undefined" !== typeof a.x5 ? c > wa ? g(c).x2 + 1 : (a.x2 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1 : "undefined" !== typeof a.x5 ? c < wa ? g(c).x2 + 1 : (a.x4 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1, I[e].textBlock.x = b + V, I[e].textBlock.y = c - I[e].height / 2, t.reversed ? (I[e].textBlock.y + I[e].height > na + B && (I[e].textBlock.y = na + B - I[e].height), I[e].textBlock.y < ra - B && (I[e].textBlock.y =
                            ra - B)) : (I[e].textBlock.y < na - B && (I[e].textBlock.y = na - B), I[e].textBlock.y + I[e].height > ra + B && (I[e].textBlock.y = ra + B - I[e].height)));
                    else
                ...
                function l() {
                    ...
                    function b() {
                        ...
                        for (var l, h = 1; h < k; h++) {
                            e = h * f;
                            for (var u = I.length - 1; 0 <= u; u--) !I[u].isDirty && (I[u].textBlock.y < e && I[u].textBlock.y + I[u].height > e) && (l = q(u), !(l >= I.length - 1) && I[u].textBlock.y + I[u].height + da > I[l].textBlock.y && (I[u].textBlock.y = I[u].textBlock.y +
                                I[u].height - e > e - I[u].textBlock.y ? e + 1 : e - I[u].height - 1))
                        }
                ...
                function h(a, b) { return (b < O.length ? I[b].textBlock.y : t.reversed ? na + B : ra + B) - (0 > a ? t.reversed ? ra - B : na - B : I[a].textBlock.y + I[a].height + da) }
                ...
                function n(a, b, c) {
                    ...
                    if (0 === X.length) l = ga;
                        ...
                        for (var q = 0; q < O.length; q++) {
                            if (1 == X.length && 0 == X[0]) { if (0 === q) { l.push(ga[q]);
                                    d = h; continue } } else 0 ===
                                q && (d = -1 * h);
                            l.push(ga[q] + d);
                    ...
                    var u = {
                        ...
                        duration: c || 500,
                        easingFunction: function(a, b, c, d) { return L.easing.easeOutQuart(a, b, c, d) },
                    ...
                    a._animator.animate(0, c, function(c) { var d = a.plotArea.ctx || a.ctx;
                        ...
                        e.dataSeries = t;
                        e.dataPoint = t.reversed ? t.dataPoints[y.length - 1 - b] : t.dataPoints[b];
                        e.index = t.reversed ? y.length - 1 - b : b;
                        a.toolTip.highlightObjects([e]); for (e = 0; e < O.length; e++) pa(d, O[e], t.fillOpacity);
                        v(d);
                        H && ("inside" !== t.indexLabelPlacement ? m(d) : f(), r(d));
                        1 <= c && (ha = !1) }, null, L.easing.easeOutQuart)
                }
                ...
                function g(a) { for (var b, c = 0; c < y.length; c++)
                ...
                var x = this;
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    for (var t = this.data[a.dataSeriesIndexes[0]], y = t.dataPoints, C = this.plotArea, B = 0.025 * C.width, D = 0.01 * C.width, z = 0, E = C.height - 2 * B, F = Math.min(C.width - 2 * D, 2.8 * C.height), H = !1, P = 0; P < y.length; P++)
                        if (!H && ("undefined" !== typeof y[P].indexLabel && null !== y[P].indexLabel && 0 < y[P].indexLabel.toString().length) && (H = !0), !H && ("undefined" !== typeof y[P].label && null !== y[P].label && 0 < y[P].label.toString().length) && (H = !0), !H && "function" === typeof t.indexLabelFormatter ||
                            "function" === typeof y[P].indexLabelFormatter) H = !0;
                    H = H || "undefined" !== typeof t.indexLabel && null !== t.indexLabel && 0 < t.indexLabel.toString().length;
                    "inside" !== t.indexLabelPlacement && H || (D = (C.width - 0.75 * F) / 2);
                    var P = C.x1 + D,
                        J = C.x2 - D,
                        M = C.y1 + B,
                        Q = C.y2 - B,
                        R = a.targetCanvasCtx || this.plotArea.ctx || this.ctx;
                    if (0 != t.length && (t.dataPoints && t.visible) && 0 !== y.length) {
                        var ba, G;
                        a = 75 * F / 100;
                        var V = 30 * (J - a) / 100;
                        "funnel" === t.type ? (ba = s(t.options.neckHeight) ? 0.35 * E : t.neckHeight, G = s(t.options.neckWidth) ? 0.25 * a : t.neckWidth, "string" ===
                            typeof ba && ba.match(/%$/) ? (ba = parseInt(ba), ba = ba * E / 100) : ba = parseInt(ba), "string" === typeof G && G.match(/%$/) ? (G = parseInt(G), G = G * a / 100) : G = parseInt(G), ba > E ? ba = E : 0 >= ba && (ba = 0), G > a ? G = a - 0.5 : 0 >= G && (G = 0)) : "pyramid" === t.type && (G = ba = 0, t.reversed = t.reversed ? !1 : !0);
                        var D = P + a / 2,
                            Y = P,
                            Z = P + a,
                            na = t.reversed ? Q : M,
                        ...
                        if (-1 !== P) {
                            if (t.reversed)
                                for (F.push(U),
                                    G = P.length - 1; 0 < G; G--) U += P[G], F.push(U);
                            else
                                for (G = 0; G < P.length; G++) U += P[G], F.push(U);
                            if (t.reversed)
                                for (G = 0; G < P.length; G++) F[G] < wa ? (a.push(K), D.push(W), ca = G) : (a.push((F[G] - na + $ * Y) / $), D.push((F[G] - na + ea * Z) / ea));
                            else
                                for (G = 0; G < P.length; G++) F[G] < wa ? (a.push((F[G] - na + $ * Y) / $), D.push((F[G] - na + ea * Z) / ea), ca = G) : (a.push(K), D.push(W));
                            for (G = 0; G < P.length - 1; G++) U = t.reversed ? y[y.length - 1 - G].color ? y[y.length - 1 - G].color : t._colorSet[(y.length - 1 - G) % t._colorSet.length] : y[G].color ? y[G].color : t._colorSet[G % t._colorSet.length],
                                G === ca ? O.push({ x1: a[G], y1: F[G], x2: D[G], y2: F[G], x3: W, y3: wa, x4: D[G + 1], y4: F[G + 1], x5: a[G + 1], y5: F[G + 1], x6: K, y6: wa, id: G, height: F[G + 1] - F[G], color: U }) : O.push({ x1: a[G], y1: F[G], x2: D[G], y2: F[G], x3: D[G + 1], y3: F[G + 1], x4: a[G + 1], y4: F[G + 1], id: G, height: F[G + 1] - F[G], color: U });
                            var da = 2,
                                I = [],
                                ha = !1,
                                X = [],
                            ...
                            a = a = 0;
                            Ba(X);
                            for (G = 0; G < y.length; G++) y[G].exploded && (P = !0, t.reversed ? X.push(y.length - 1 - G) : X.push(G));
                            R.clearRect(C.x1, C.y1, C.width, C.height);
                            R.fillStyle = x.backgroundColor;
                            R.fillRect(C.x1, C.y1, C.width, C.height);
                            if (H && t.visible && (b(), f(), e(), "inside" !== t.indexLabelPlacement)) { l(); for (G = 0; G < y.length; G++) I[G].isDirty || (a = I[G].textBlock.x + I[G].width, a = (J - a) / 2, 0 == G && (z = a), z > a && (z = a)); for (G = 0; G < O.length; G++) O[G].x1 += z, O[G].x2 += z, O[G].x3 += z, O[G].x4 += z, O[G].x5 && (O[G].x5 += z, O[G].x6 += z), I[G].textBlock.x += z }
                            for (G = 0; G < O.length; G++) z = O[G], pa(R, z, t.fillOpacity), ga.push(z.y1);
                            v(R);
                            H && t.visible && ("inside" === t.indexLabelPlacement || x.animationEnabled || m(R), x.animationEnabled || r());
                            if (!H)
                                for (G = 0; G < y.length; G++) z = t.dataPointIds[G],
                                    a = { id: z, objectType: "dataPoint", dataPointIndex: G, dataSeriesIndex: 0, funnelSection: O[t.reversed ? y.length - 1 - G : G] }, x._eventManager.objectMap[z] = a;
                            !x.animationEnabled && P ? n(x, -1, 0) : x.animationEnabled && !x.animatedRender && n(x, -1, 0);
                            this.funnelPyramidClickHandler = function(a) {
                                var b = -1;
                                if (!ha && !x.isAnimating && (s(a.dataSeries.explodeOnClick) || a.dataSeries.explodeOnClick) && (b = t.reversed ? y.length - 1 - a.dataPointIndex : a.dataPointIndex, 0 <= b)) {
                                    a = b;
                                    if ("funnel" === t.type || "pyramid" === t.type) t.reversed ? y[y.length - 1 - a].exploded =
                                        y[y.length - 1 - a].exploded ? !1 : !0 : y[a].exploded = y[a].exploded ? !1 : !0;
                                    n(x, b, 500)
                                }
                            };
                            return { source: R, dest: this.plotArea.ctx, animationCallback: function(a, b) { L.fadeInAnimation(a, b);
                                    1 <= a && (n(x, -1, 500), v(x.plotArea.ctx || x.ctx)) }, easingFunction: L.easing.easeInQuad, animationBase: 0 }
                        }
                    }
                }
            };
        ...
        n.prototype.replaceKeywordsWithValue = function(a, d, c, b, e) {
            ...
            return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
                ...
                try { var g = a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);
                    g && 0 < g.length && (k = Ea(g[2]), a = Ea(g[1])) } catch (l) {}
                g = null;
        ...
        F.prototype.setLayout = function() {
                    ...
                    if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type && "pyramid" !== p.type) {
                        ...
                        for (var y = 0; y < p.dataPoints.length; y++) {
                            var x = p.dataPoints[y],
                                q = x.legendMarkerType ? x.legendMarkerType : p.legendMarkerType ? p.legendMarkerType : H.getDefaultLegendMarker(p.type),
                                ...
                                r = x.legendMarkerColor ? x.legendMarkerColor :
                                p.legendMarkerColor ? p.legendMarkerColor : x.color ? x.color : p.color ? p.color : p._colorSet[y % p._colorSet.length],
                                ...
                                t = x.legendMarkerBorderThickness ? x.legendMarkerBorderThickness : p.legendMarkerBorderThickness ? p.legendMarkerBorderThickness : x.markerBorderThickness || p.markerBorderThickness ? Math.max(1, Math.round(0.2 * w)) : 0,
                                g = this.chart.replaceKeywordsWithValue(g,
                                    x, p, y),
                                q = { markerType: q, markerColor: r, text: g, textBlock: null, chartType: p.type, markerSize: w, dataSeriesIndex: m, dataPointIndex: y, markerBorderColor: v, markerBorderThickness: t };
            ...
            if (0 < n.length) {
                p = null;
                r = g = x = y = 0;
                x = null !== this.itemWidth ? null !== this.itemMaxWidth ? Math.min(this.itemWidth, this.itemMaxWidth, f) : this.itemMaxWidth = Math.min(this.itemWidth, f) : null !== this.itemMaxWidth ? Math.min(this.itemMaxWidth, f) : this.itemMaxWidth =
                    f;
            ...
            for (var h = 0, n = 0; n < l.length; n++) {
                for (var k = l[n], m = 0, p = 0; p < k.items.length; p++) {
                    ...
                    if ("line" === q.chartType || "stepLine" === q.chartType || "spline" === q.chartType) this.ctx.strokeStyle = q.lineColor, this.ctx.lineWidth = Math.ceil(this.lineHeight / 8), this.ctx.beginPath(), this.ctx.moveTo(g - 0.1 * this.lineHeight, r + this.lineHeight / 2), this.ctx.lineTo(g + 0.85 * this.lineHeight, r + this.lineHeight / 2), this.ctx.stroke(), s -=
                        0.1 * this.lineHeight;
                    if ("error" === q.chartType) { this.ctx.strokeStyle = this.errorMarkerColor[0];
                        this.ctx.lineWidth = f / 8;
                        this.ctx.beginPath(); var w = g - 0.08 * this.lineHeight + 0.1 * this.lineHeight,
                            t = r + 0.15 * this.lineHeight,
                            y = 0.7 * this.lineHeight,
                            v = y + 0.02 * this.lineHeight;
                        this.ctx.moveTo(w, t);
                        this.ctx.lineTo(w + y, t);
                        this.ctx.stroke();
                        this.ctx.beginPath();
                        this.ctx.moveTo(w + y / 2, t);
                        this.ctx.lineTo(w + y / 2, t + v);
                        this.ctx.stroke();
                        this.ctx.beginPath();
                        this.ctx.moveTo(w, t + v);
                        this.ctx.lineTo(w + y, t + v);
                        this.ctx.stroke();
        ...
        H.prototype.getDataPointAtX = function(a, d) {
            ...
            for (;;) {
                f =
                    0 < l ? m + e : m - e;
                if (0 <= f && f < this.dataPoints.length) { var b = this.dataPoints[f],
                        p = this.axisX.logarithmic ? b.x > a ? b.x / a : a / b.x : Math.abs(b.x - a);
                    p < c.distance && (c.dataPoint = b, c.distance = p, c.index = f);
                    b = p;
                    b <= h ? h = b : 0 < l ? n++ : k++; if (1E3 < n && 1E3 < k) break } else if (0 > m - e && m + e >= this.dataPoints.length) break; - 1 === l ? (e++, l = 1) : l = -1
            }
        ...
        E.prototype.createExtraLabelsForLog = function(a) {
            ...
            if (!(5 < a)) {
                ...
                if (Math.log(this.range) / Math.log(d / this.viewportMinimum) <
                    this.noTicks - 1) { for (var c = E.getNiceNumber((d - this.viewportMinimum) / Math.min(Math.max(2, this.noTicks - this.logLabelValues.length), 3), !0), b = Math.ceil(this.viewportMinimum / c) * c; b < d; b += c) b < this.viewportMinimum || this.logLabelValues.push(b);
        ...
        E.prototype.createLabels = function() {
            ...
            if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
                ...
                if (this.logarithmic && !this.equidistantInterval)
                    for (this.logLabelValues || (this.logLabelValues = [], this.createExtraLabelsForLog()), b = 0, g = q; b < this.logLabelValues.length; b++)
                        if (c =
                            ...
                            m = c;
                            a || (a = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.options, value: m, label: this.labels[m] ? this.labels[m] : null }) : "axisX" === this.type && this.labels[m] ? this.labels[m] : ea(m, this.valueFormatString, this.chart._cultureInfo), a = new ia(this.ctx, {
                                x: 0,
                                y: 0,
                                maxWidth: f,
                                maxHeight: l,
                ...
                for (this.intervalStartPosition =
                    ...
                    a || (a = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.options, value: new Date(m), label: this.labels[m] ? this.labels[m] : null }) : "axisX" === this.type && this.labels[m] ?
                        this.labels[m] : za(m, this.valueFormatString, this.chart._cultureInfo), a = new ia(this.ctx, {
                            x: 0,
                            y: 0,
                            maxWidth: f,
                            backgroundColor: this.labelBackgroundColor,
            ...
            for (b = 0; b < this._labels.length; b++) { a = this._labels[b].textBlock;
                a.maxWidth = f;
                a.maxHeight = l; var r = a.measureText();
                n = r.height }
            e = [];
            q = p = 0;
        ...
        E.setLayout = function(a, d, c, b, e, f) {
            ...
            for (var v = w = 0, t = 0, y = 0, x = 0, B = 0, D = 0, z, E, F = h = 0, H, J, L, r = H = J = L = !1, g = 0; g < q.length; g++) q[g] && q[g].title && (q[g]._titleTextBlock = new ia(q[g].ctx, {
                text: q[g].title,
                horizontalAlign: "center",
                ...
                if ("normal" === e) {
                    for (var y = [], x = [], B = [], D = [], M = [], N = [], Q = [], R = []; 4 >
                        ...
                        var G = 0,
                            ...
                            $ = 0;
                        if (c && 0 < c.length)
                            for (B = [], g = O = 0; g < c.length; g++) B.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)), O += B[g], K += c[g] && !m.isNavigator ? c[g].margin : 0;
                        ...
                        if (c && 0 < c.length)
                            for (g = 0; g < c.length; g++) K = m.isNavigator ? 0 : 10, c[g] && (l = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), K = c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[c[g]._labels.length - 1].textBlock.height / 2 : p, h = Math.round(f.y1 + W + X < Math.max(K, p) ? Math.max(K, p) : f.y1 + W + X), n = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), K = 0 < a.length ? 0 : c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[0].textBlock.height /
                    ...
                    for (N = []; 4 > w;) {
                        ...
                        if (a && 0 < a.length)
                            for (F = [], g = Y = 0; g < a.length; g++) F.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateWidth() : 0)), Y += F[g], e += a[g] && !m.isNavigator ? a[g].margin : 0;
                        ...
                        if (a && 0 < a.length)
                            for (g = 0; g < a.length; g++) {
                                ...
                                k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - V > m.height - Math.max(K, 10) ? m.height - Math.max(K, 10) : f.y2 - V) : f.y2 > m.height - Math.max(K, 10) ? m.height - Math.max(K, 10) : f.y2;
                                if (c && 0 < c.length)
                                    for (K = 0; K < c.length; K++) c[K] && c[K].labelAutoFit && (n = 0 > c[K].labelAngle ? Math.max(n, y) : 0 === c[K].labelAngle ? Math.max(n, y / 2) : n, l =
                                        0 > c[K].labelAngle || 0 === c[K].labelAngle ? n - Y : l);
                                if (b && 0 < b.length)
                                    for (K = 0; K < b.length; K++) b[K] && b[K].labelAutoFit && (n = b[K].lineCoordinates.x1, l = n - Y);
                                a[g].lineCoordinates = { x1: n - Q, y1: h, x2: n - Q, y2: k, height: Math.abs(k - h) };
                        ...
                        if (d && 0 < d.length)
                            for (g = 0; g < d.length; g++) {
                                ...
                                k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - V > m.height - Math.max(K, 10) ? m.height - Math.max(K, 10) : f.y2 - V) : f.y2 > m.height - Math.max(K, 10) ? m.height - Math.max(K, 10) : f.y2;
                                if (c && 0 < c.length)
                                    for (K = 0; K < c.length; K++) c[K] && c[K].labelAutoFit && (n = 0 > c[K].labelAngle ? Math.max(n, y) : 0 === c[K].labelAngle ? Math.max(n, y / 2) : n, l = 0 > c[K].labelAngle || 0 === c[K].labelAngle ? n - U : l);
                                if (b && 0 < b.length)
                                    for (K = 0; K < b.length; K++) b[K] &&
                                        b[K].labelAutoFit && (n = b[K].lineCoordinates.x2, l = n - U);
                        ...
                        if (0 < w) {
                            ...
                            if (b && 0 < b.length)
                                for (g = 0; g < b.length; g++) L = t[w - 1][g] === t[w][g] ? !0 : !1;
                            else L = !0
                        }
                        if (r && H && J && L) break;
                        w++
            ...
            if ("undefined" === typeof this.options.interval) {
                ...
                if ("left" === this._position || "right" === this._position)
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        ...
                        this._labels = c
                    } else { for (k = 0; k < this._labels.length; k++) p = this._labels[k], p.position < this.viewportMinimum || (m = p.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + p.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), b += m);
        ...
        E.prototype.renderStripLinesOfThicknessType = function(a) {
            if (this.stripLines &&
                ...
                for (var d = this, c, b = 0, e = 0, f = !1, l = !1, h = [], n = [], l = !1, b = 0; b < this.stripLines.length; b++) { var k = this.stripLines[b];
            ...
            if ("bottom" === this._position || "top" === this._position) {
                if (this.lineThickness) {
                    ...
                    if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex))
                        if (s(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + b;
                            ...
                            for (var n = this.scaleBreaks.firstBreakIndex; n <= this.scaleBreaks.lastBreakIndex; n++) d.moveTo(e,
                                h), d.lineTo(this.scaleBreaks._appliedBreaks[n].startPixel + c, h), e = this.scaleBreaks._appliedBreaks[n].endPixel + b;
                    e && (d.moveTo(e, h), d.lineTo(f, h));
                    d.stroke()
                }
                ...
                if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex))
                    if (s(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + c;
                        ...
                        for (n = this.scaleBreaks.firstBreakIndex; n <= this.scaleBreaks.lastBreakIndex; n++) d.moveTo(h, e), d.lineTo(h, this.scaleBreaks._appliedBreaks[n].startPixel + b), e = this.scaleBreaks._appliedBreaks[n].endPixel + c;
                e && (d.moveTo(h, e), d.lineTo(h, f));
                d.stroke()
            }
            w &&
        ...
        E.prototype.setViewPortRange = function(a, d) { this.sessionVariables.newViewportMinimum = this.viewportMinimum = Math.min(a, d);
        ...
        E.prototype.calculateLogarithmicAxisParameters = function() {
            ...
            if (!this.options.interval && this.range < Math.pow(this.logarithmBase, 8 > this.viewportMaximum || 3 > a ? 2 : 3)) { for (d = Math.floor(this.viewportMinimum / c + 0.5) * c; d < this.viewportMinimum;) d += c;
                ...
                this.interval = c } else this.options.interval || (c = Math.ceil(this.interval), this.range > this.interval && (this.interval = c, b = Math.pow(this.logarithmBase, Math.floor(Math.log(this.viewportMinimum) / (d * this.interval) + 0.2) * this.interval))),
        ...
        E.generateValueFormatString = function(a, d) { var c = "#,##0.",
                b = d;
            1 > a && (b += Math.floor(Math.abs(Math.log(a) / Math.LN10)), isNaN(b) || !isFinite(b)) && (b = d); for (var e = 0; e < b; e++) c += "#"; return c };
        ...
        E.getNiceNumber = function(a, d) { var c = Math.floor(Math.log(a) / Math.LN10),
                b = a / Math.pow(10, c),
        ...
        U.prototype.createUserOptions = function(a) {
            if ("undefined" !==
                typeof a || this.options._isPlaceholder) { var d = 0;
        ...
        U.prototype.render = function(a) {
            if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
                ...
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                    ...
                    else if ("wavy" === this.type) { s = b;
                    k = e;
                    f = 0.5;
                    m = (n - k) / a / 3; for (var q = 0; q < m; q++) this.ctx.bezierCurveTo(s + f * a, k + a, s + f * a, k + 2 * a, s, k + 3 * a), k += 3 * a, f *= -1;
                    this.ctx.bezierCurveTo(s + f * a, k + a, s + f * a, k + 2 * a, s, k + 3 * a);
                    s = h;
                    f *= -1;
                    this.ctx.lineTo(s, k); for (q = 0; q < m; q++) this.ctx.bezierCurveTo(s + f * a, k - a, s + f * a, k - 2 * a, s, k - 3 * a), k -= 3 * a, f *= -1 } else {
                    if ("zigzag" ===
                        this.type) { f = -1;
                        k = e + a;
                        s = b + a;
                        m = (n - k) / a / 2; for (q = 0; q < m; q++) this.ctx.lineTo(s, k), s += 2 * f * a, k += 2 * a, f *= -1;
                        this.ctx.lineTo(s, k);
                        s += h - b; for (q = 0; q < m + 1; q++) this.ctx.lineTo(s, k), s += 2 * f * a, k -= 2 * a, f *= -1;
                    ...
                    k = e - a;
                    s = b + a;
                    m = (h - s) / a / 2; for (q = 0; q < m; q++) this.ctx.lineTo(s, k), k += 2 * f * a, s += 2 * a, f *= -1;
                    this.ctx.lineTo(s, k);
                    k += n - e; for (q = 0; q < m + 1; q++) this.ctx.lineTo(s, k), k += 2 * f * a, s -= 2 * a, f *= -1;
        ...
        oa(M, V);
        M.prototype.createUserOptions = function(a) { if ("undefined" !== typeof a || this.options._isPlaceholder) { var d = 0;
                this.parent.options._isPlaceholder && this.parent.createUserOptions();
        ...
        $.prototype.showAt = function(a) {
            ...
            if ("xySwapped" === d.plotInfo.axisPlacement)
                ...
                for (b = 0; b < d.axisX.length; b++) this.parent === d.axisX[b] && (d.axisX[b]._crosshairValue = a >= d.axisX[b].viewportMinimum && a <= d.axisX[b].viewportMaximum ? a : null);
                    ...
                    for (b = 0; b < d.axisX2.length; b++) this.parent === d.axisX2[b] && (d.axisX2[b]._crosshairValue = a >= d.axisX2[b].viewportMinimum && a <= d.axisX2[b].viewportMaximum ? a : null) } else if ("bottom" === this.parent._position)
        ...
        $.prototype.render = function(a, d, c) {
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    x = 0;
                    if ("rangeBar" === m[0].dataSeries.type ||
                        "error" === m[0].dataSeries.type)
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(m[x].dataPoint.y[0])), t = 0, r = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                                for (var y = 0; y < m[r].dataPoint.y.length; y++) t = Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y[y])), t < v && (v = t, x = r);
                            else t = Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y)), t < v && (v = t, x = r);
                    else if ("stackedBar" === m[0].dataSeries.type)
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), C = t =
                                0, r = x = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                                for (y = 0; y < m[r].dataPoint.y.length; y++) t = Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y[y])), t < v && (v = t, x = r);
                            else C += m[r].dataPoint.y, t = Math.abs(a - this.parent.convertValueToPixel(C)), t < v && (v = t, x = r);
                    else if ("stackedBar100" === m[0].dataSeries.type)
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), B = C = t = 0, r = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                                for (y = 0; y < m[r].dataPoint.y.length; y++) t =
                                    Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y[y])), t < v && (v = t, x = r);
                            else C += m[r].dataPoint.y, B = m[r].dataPoint.x.getTime ? m[r].dataPoint.x.getTime() : m[r].dataPoint.x, B = 100 * (C / m[r].dataSeries.plotUnit.dataPointYSums[B]), t = Math.abs(a - this.parent.convertValueToPixel(B)), t < v && (v = t, x = r);
                    else
                        for (v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), r = x = t = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                                for (y = 0; y < m[r].dataPoint.y.length; y++) t = Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y[y])),
                                    t < v && (v = t, x = r);
                            else t = Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y)), t < v && (v = t, x = r);
                    y = m[x];
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if ("rangeBar" === this.parent.dataSeries[x].type || "error" === this.parent.dataSeries[x].type) {
                            ...
                            for (r = t = 0; r < y.dataPoint.y.length; r++) t = Math.abs(a - this.parent.convertValueToPixel(y.dataPoint.y[r])), t < v && (v = t, b = r);
                            ...
                            k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : y.dataPoint.y[b] }) : s(this.options.label) ? ea(c ? c : y.dataPoint.y[b], this.valueFormatString, this.chart._cultureInfo) : this.label
                        } else if ("stackedBar" === this.parent.dataSeries[x].type) {
                            v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y));
                            C = t = 0;
                            for (r = x; 0 <= r; r--) C += m[r].dataPoint.y, t = Math.abs(a -
                                this.parent.convertValueToPixel(C)), t < v && (v = t, b = r);
                            n = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(C) << 0) + 0.5 : this.parent.convertValueToPixel(C) << 0;
                            this.value = C;
                            k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : y.dataPoint.y }) : s(this.options.label) ? ea(c ? c : y.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label
                        } else if ("stackedBar100" === this.parent.dataSeries[x].type) {
                            v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y));
                            B = C = t = 0;
                            for (r = x; 0 <= r; r--) C += m[r].dataPoint.y, B = m[r].dataPoint.x.getTime ? m[r].dataPoint.x.getTime() : m[r].dataPoint.x, B = 100 * (C / m[r].dataSeries.plotUnit.dataPointYSums[B]), t = Math.abs(a - this.parent.convertValueToPixel(B)), t < v && (v = t, b = r);
                            n = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(B) << 0) + 0.5 : this.parent.convertValueToPixel(B) << 0;
                            this.value = B;
                        ...
                        } else n = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(y.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(y.dataPoint.y) << 0, this.value = y.dataPoint.y, k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : y.dataPoint.y }) : s(this.options.label) ? ea(c ? c : y.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label;
                        b = e = n;
                        ...
                        } else "dateTime" === this.parent.valueType ? k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : y.dataPoint.x }) : s(this.options.label) ? za(c ? c : y.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) :
                            this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : y.dataPoint.x }) : s(this.options.label) ? ea(c ? c : y.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label);
                    ...
                    for (x = 0; x < this.parent.dataSeries.length; x++)(v = this.parent.dataSeries[x].getDataPointAtX(r, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[x], null !== v.dataPoint.y &&
                        v.dataSeries.visible && m.push(v));
                    if (0 === m.length) return;
                    m.sort(function(a, b) { return a.distance - b.distance });
                    y = m[0];
                    ...
                    if (B) {
                        if ("axisX" ===
                            this.parent.type)
                            for (r = this.parent.convertPixelToValue({ x: a }), v = null, x = 0; x < this.parent.dataSeries.length; x++)(v = this.parent.dataSeries[x].getDataPointAtX(r, !0)) && 0 <= v.index && (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: y.dataPoint.x }) : s(this.options.label) ? v.dataPoint.label : this.label)
                    } else "dateTime" === this.parent.valueType ? k.text = this.labelFormatter ? this.labelFormatter({
                        chart: this.chart,
                        axis: this.parent.options,
                        crosshair: this.options,
                        value: y.dataPoint.x
                    }) : s(this.options.label) ? za(c ? c : y.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: y.dataPoint.x }) : s(this.options.label) ? ea(c ? c : y.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label);
                    this.value = y.dataPoint.x;
                    k.x = b - k.measureText().width / 2;
                    ...
                    for (x = 0; x < this.parent.dataSeries.length; x++)(v = this.parent.dataSeries[x].getDataPointAtX(r, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[x], null !== v.dataPoint.y && v.dataSeries.visible && m.push(v));
                    if (0 === m.length) return;
                    m.sort(function(a, b) { return a.distance - b.distance });
                    x = 0;
                    if ("rangeColumn" === m[0].dataSeries.type || "rangeArea" === m[0].dataSeries.type || "error" === m[0].dataSeries.type || "rangeSplineArea" === m[0].dataSeries.type || "candlestick" === m[0].dataSeries.type || "ohlc" === m[0].dataSeries.type || "boxAndWhisker" === m[0].dataSeries.type)
                        for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y[0])),
                            r = t = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                                for (y = 0; y < m[r].dataPoint.y.length; y++) t = Math.abs(d - this.parent.convertValueToPixel(m[r].dataPoint.y[y])), t < v && (v = t, x = r);
                            else t = Math.abs(d - this.parent.convertValueToPixel(m[r].dataPoint.y)), t < v && (v = t, x = r);
                    else if ("stackedColumn" === m[0].dataSeries.type || "stackedArea" === m[0].dataSeries.type)
                        for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y)), r = C = t = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                                for (y = 0; y <
                                    m[r].dataPoint.y.length; y++) t = Math.abs(d - this.parent.convertValueToPixel(m[r].dataPoint.y[y])), t < v && (v = t, x = r);
                            else C += m[r].dataPoint.y, t = Math.abs(d - this.parent.convertValueToPixel(C)), t < v && (v = t, x = r);
                    else if ("stackedColumn100" === m[0].dataSeries.type || "stackedArea100" === m[0].dataSeries.type)
                        for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y)), r = B = C = t = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                                for (y = 0; y < m[r].dataPoint.y.length; y++) t = Math.abs(d - this.parent.convertValueToPixel(m[r].dataPoint.y[y])),
                                    t < v && (v = t, x = r);
                            else C += m[r].dataPoint.y, B = m[r].dataPoint.x.getTime ? m[r].dataPoint.x.getTime() : m[r].dataPoint.x, B = 100 * (C / m[r].dataSeries.plotUnit.dataPointYSums[B]), t = Math.abs(d - this.parent.convertValueToPixel(B)), t < v && (v = t, x = r);
                    else
                        for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y)), r = t = 0; r < m.length; r++)
                            if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                                for (y = 0; y < m[r].dataPoint.y.length; y++) t = Math.abs(d - this.parent.convertValueToPixel(m[r].dataPoint.y[y])), t < v && (v = t, x = r);
                            else t = Math.abs(d -
                                this.parent.convertValueToPixel(m[r].dataPoint.y)), t < v && (v = t, x = r);
                    y = m[x];
                    b = 0;
                    if ("rangeColumn" === this.parent.dataSeries[x].type || "rangeArea" === this.parent.dataSeries[x].type || "error" === this.parent.dataSeries[x].type || "rangeSplineArea" === this.parent.dataSeries[x].type || "candlestick" === this.parent.dataSeries[x].type || "ohlc" === this.parent.dataSeries[x].type || "boxAndWhisker" === this.parent.dataSeries[x].type) {
                        ...
                        for (r = t = 0; r < y.dataPoint.y.length; r++) t =
                            Math.abs(d - this.parent.convertValueToPixel(y.dataPoint.y[r])), t < v && (v = t, b = r);
                        ...
                        C = t = 0;
                        for (r = x; 0 <= r; r--) C += m[r].dataPoint.y, t = Math.abs(d - this.parent.convertValueToPixel(C)), t < v && (v = t, b = r);
                        w = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(C) << 0) + 0.5 : this.parent.convertValueToPixel(C) << 0;
                        k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : y.dataPoint.y }) : s(this.options.label) ?
                            ea(c ? c : y.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label;
                        this.value = C
                    } else if ("stackedColumn100" === this.parent.dataSeries[x].type || "stackedArea100" === this.parent.dataSeries[x].type) {
                        v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y));
                        C = t = 0;
                        for (r = x; 0 <= r; r--) C += m[r].dataPoint.y, B = m[r].dataPoint.x.getTime ? m[r].dataPoint.x.getTime() : m[r].dataPoint.x, B = 100 * (C / m[r].dataSeries.plotUnit.dataPointYSums[B]), t = Math.abs(d - this.parent.convertValueToPixel(B)), t < v && (v = t, b = r);
                        w =
                        ...
                        0, k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: y.dataPoint.y }) : s(this.options.label) ? ea(c ? c : y.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = y.dataPoint.y);
                    f = h = w;
                    b = this.chart.plotArea.x1;
                    e = this.chart.plotArea.x2;
                    this.bounds = { x1: b, y1: f - p / 2, x2: e, y2: h + p / 2 };
                ...
                if ("left" ===
                    ...
                    p && (q.moveTo(b, f), q.lineTo(e, h), q.stroke(), this._hidden = !1), q.restore(), !s(k.text) && ("number" === typeof k.text.valueOf() || 0 < k.text.length) && k.render(!0))
            } else {
                ...
                else if ("left" === this.parent._position || "right" === this.parent._position) f = h = w = 1 === q.lineWidth % 2 ? (d << 0) + 0.5 : d << 0, b = this.chart.plotArea.x1, e = this.chart.plotArea.x2,
                    this.bounds = { x1: b, y1: f - p / 2, x2: e, y2: h + p / 2 };
                if ("xySwapped" === this.chart.plotInfo.axisPlacement)
                    if ("left" === this.parent._position || "right" === this.parent._position) {
                        ...
                        if (B) {
                            if ("axisX" === this.parent.type)
                                for (r = this.parent.convertPixelToValue({ y: d }), v = null, x = 0; x < this.parent.dataSeries.length; x++)(v = this.parent.dataSeries[x].getDataPointAtX(r, !0)) && 0 <= v.index &&
                    ...
                    if (B) { if ("axisX" === this.parent.type)
                            for (r = this.parent.convertPixelToValue({ x: a }), v = null, x = 0; x < this.parent.dataSeries.length; x++)(v = this.parent.dataSeries[x].getDataPointAtX(r, !0)) && 0 <= v.index && (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : this.parent.convertPixelToValue(a) }) : s(this.options.label) ? c ? c : v.dataPoint.label : this.label) } else "dateTime" ===
            ...
            if ("bottom" === this.parent._position ||
                "top" === this.parent._position) this._updatedValue = this.parent.convertPixelToValue(n);
        ...
        Y.prototype.mouseMoveHandler = function(a, d) { this._lastUpdated && 4 > (new Date).getTime() - this._lastUpdated || (this._lastUpdated = (new Date).getTime(), this.chart.resetOverlayedCanvas(), this._updateToolTip(a, d)) };
            ...
            if (!this.chart.disableToolTip) {
                ...
                if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                    if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                        ...
                        if (this.chart.axisX)
                            for (var v = 0; v < this.chart.axisX.length; v++) {
                                for (var h =
                                        this.chart.axisX[v].convertPixelToValue({ y: d }), k = null, b = 0; b < this.chart.axisX[v].dataSeries.length; b++)(k = this.chart.axisX[v].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[v].dataSeries[b], null !== k.dataPoint.y && n.push(k));
                                k = null
                            }
                        if (this.chart.axisX2)
                            for (v = 0; v < this.chart.axisX2.length; v++) {
                                ...
                                k = null;
                                for (b = 0; b < this.chart.axisX2[v].dataSeries.length; b++)(k = this.chart.axisX2[v].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index &&
                                    (k.dataSeries = this.chart.axisX2[v].dataSeries[b], null !== k.dataPoint.y && n.push(k));
                                k = null
                            }
                    } else {
                        n = [];
                        ...
                        if (this.chart.axisX2)
                            for (v = 0; v < this.chart.axisX2.length; v++)
                                for (h = this.chart.axisX2[v].convertPixelToValue({ x: a }),
                                    k = null, b = 0; b < this.chart.axisX2[v].dataSeries.length; b++)(k = this.chart.axisX2[v].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX2[v].dataSeries[b], null !== k.dataPoint.y && n.push(k))
                    }
                    ...
                    if (k = this.chart.getDataPointAtXY(a, d, c)) this.currentDataPointIndex = k.dataPointIndex, this.currentSeriesIndex =
                        ...
                        if (k = Ya(a, d, this.chart._eventManager.ghostCtx), 0 < k && "undefined" !== typeof this.chart._eventManager.objectMap[k]) { k = this.chart._eventManager.objectMap[k]; if ("legendItem" === k.objectType) return;
                            this.currentSeriesIndex = k.dataSeriesIndex;
                            this.currentDataPointIndex = 0 <= k.dataPointIndex ? k.dataPointIndex : -1 } else this.currentDataPointIndex = -1;
                ...
                if (0 < f.length) {
                    ...
                    if (this.enabled) {
                        var m = "",
                            m = this.getToolTipInnerHTML({ entries: f });
                        if (null !== m) {
                    ...
                    m = { chart: this.chart, toolTip: this.options, content: m, entries: d };
                    this._entries = f;
                    this.dispatchEvent("updated", m, this)
                } else this.hide()
            }
        };
                    ...
                    !1 === f.highlightEnabled || !0 !== b.highlightEnabled && !0 !== f.highlightEnabled ||
                        ("line" === b.type || "stepLine" === b.type || "spline" === b.type || "scatter" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "stackedArea" === b.type || "stackedArea100" === b.type || "rangeArea" === b.type || "rangeSplineArea" === b.type ? (f = b.getMarkerProperties(h, e.x1, e.y1, this.chart.overlaidCanvasCtx), f.size = Math.max(1.5 * f.size << 0, 10), f.borderColor = f.borderColor || "#FFFFFF", f.borderThickness = f.borderThickness || Math.ceil(0.1 * f.size), W.drawMarkers([f]), "undefined" !== typeof e.y2 && (f = b.getMarkerProperties(h,
                            ...
                            b.type || "stackedBar100" === b.type || "rangeColumn" === b.type || "waterfall" === b.type ? ca(d, e.x1, e.y1, e.x2, e.y2, "white", 0, null, !1, !1, !1, !1, 0.3) : "pie" === b.type || "doughnut" === b.type ? X(d, e.center, e.radius, "white", b.type, e.startAngle, e.endAngle, 0.3, e.percentInnerRadius) : "funnel" === b.type || "pyramid" === b.type ? pa(d, e.funnelSection, 0.3, "white") : "candlestick" === b.type ? (d.globalAlpha = 1, d.strokeStyle = e.color, d.lineWidth = 2 * e.borderThickness, b = 0 === d.lineWidth % 2 ? 0 : 0.5, d.beginPath(), d.moveTo(e.x3 - b, Math.min(e.y2, e.y3)),
                                ...
                                d.stroke()), d.globalAlpha = 1, d.strokeStyle = e.lineColor, d.lineWidth = 2 * e.lineThickness, 0 < e.lineThickness && (d.beginPath(), d.moveTo(e.x1, e.y5), d.lineTo(e.x2, e.y5), d.stroke()), d.restore(), d.globalAlpha = 1) : "error" === b.type && x(d, e.x1, e.y1, e.x2, e.y2, "white", e.whiskerProperties, e.stemProperties, e.isXYSwapped, 0.3))
                }
            }
            d.restore();
            d.globalAlpha = 1;
        ...
        Y.prototype.getToolTipInnerHTML = function(a) {
            ...
            for (var d = null, c = null, b = null, e = 0, f = "", h = !0, n = 0; n < a.length; n++)
                if (a[n].dataSeries.toolTipContent ||
                    a[n].dataPoint.toolTipContent) { h = !1; break }
            if (h && (this.content && "function" === typeof this.content || this.contentFormatter)) a = { chart: this.chart, toolTip: this.options, entries: a }, d = this.contentFormatter ? this.contentFormatter(a) : this.content(a);
                ...
                for (var s = null, k = "", n = 0; n < a.length; n++) c = a[n].dataSeries, b = a[n].dataPoint, e = a[n].index, f = "", 0 === n && (h && !this.content) && (this.chart.axisX && 0 < this.chart.axisX.length ? k += "undefined" !== typeof this.chart.axisX[0].labels[b.x] ?
                    ...
                    null === d && (d = ""), !0 === this.reversed ? (d = this.chart.replaceKeywordsWithValue(f, b, c, e) + d, n < a.length - 1 && (d = "</br>" + d)) : (d += this.chart.replaceKeywordsWithValue(f, b, c, e), n < a.length - 1 && (d += "</br>")));
                null !== d && (d = k + d)
            } else {
                c = a[0].dataSeries;
                b = a[0].dataPoint;
        ...
        Y.prototype.enableAnimation = function() { if (!this.container.style.WebkitTransition) { var a = this.getContainerTransition(this.containerTransitionDuration);
        ...
        Y.prototype.hide = function(a) { this.container && (this.container.style.display = "none", this.currentSeriesIndex = -1, this._prevY = this._prevX = NaN, ("undefined" === typeof a || a) && this.chart.resetOverlayedCanvas()) };
        Y.prototype.show = function(a, d, c) { this._updateToolTip(a, d, "undefined" === typeof c ? !1 : c) };
        ...
        Y.prototype.getContainerTransition = function(a) { return "left " + a + "s ease-out 0s, bottom " + a + "s ease-out 0s" };
