                ...
                <tbody>
                    <tr>
                        ...
                        foreach ($departemen->result() as $kamu => $data) { ?>
                            ...
                            <td><?= $data->name ?></td>
                            <td  width="10%">
                                <a href="<?= site_url('departemen/del/' . $data->id_jabatan) ?>" class="btn btn-success btn-lg-2"><i class="fa fa-trash"></i> </a>
                                <a href="<?= site_url('departemen/edit/' . $data->id_jabatan) ?> " class="btn btn-warning  btn-lg-2"><i class="fa fa-eye"></i> </a>
                            </td>
                    </tr>
                <?php } ?>
                </tbody>
